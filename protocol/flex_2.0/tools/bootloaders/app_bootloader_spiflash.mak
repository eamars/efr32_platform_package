...
GLOBAL_HALCONFIG_DIR := ../../../../platform/halconfig
...
CDEFS = \
      -DBOARD_HEADER=\"hal-config-board.h\" \
      ...
      -DJAMBUILD \
      -DHAL_CONFIG=1 \
      -DFRAMEWORK_HAL_CONFIG=\"connect/hal-config/flex-config.h\" \
      -DAPP_HAL_CONFIG=\"app-bootloader-spiflash.h\" \
...
CINC = -I. \
	...
	-I$(STACK_DIR)/include/ \
	-I$(PLUGIN_DIR) \
	-I$(GLOBAL_HALCONFIG_DIR)/inc/hal-config \
	-Iconnect/hal-config
