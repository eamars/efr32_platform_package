...
/** @brief \deprecated  The maximum allowed endpoint value. This define has been
 *  deprecated, you should use the ::emberGetMaximumPayloadLength API instead.
 */
 ...
 * node type, is not joined to a coordinator and the poll destination was not
 * correctly set via the ::emberSetPollDestinationAddress API.
