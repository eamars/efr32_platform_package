...
static void ncpMacMessageSendCommand(void)
{
  ...
  macFrame.srcAddress.addr.shortAddress = emberUnsignedCommandArgument(3);
...
static void ncpMacSetAllocateAddressFlagCommand(void)
{
  bool allocateAddress;
  allocateAddress = (bool) emberUnsignedCommandArgument(0);
  EmberStatus status = emberMacSetAllocateAddressFlag(allocateAddress);
  emSendBinaryManagementCommand(EMBER_MAC_SET_ALLOCATE_ADDRESS_FLAG_RETURN_IDENTIFIER,
                                "u",
                                status);
}
...
const EmberCommandEntry emberCommandTable[] = {
  ...
  emberBinaryCommandEntryAction(EMBER_MAC_MESSAGE_SEND_COMMAND_IDENTIFIER,
                                ...
                                "vbuvbuvvuuuubu",
                                NULL),
  emberBinaryCommandEntryAction(EMBER_MAC_SET_ALLOCATE_ADDRESS_FLAG_COMMAND_IDENTIFIER,
                                ncpMacSetAllocateAddressFlagCommand,
                                "u",
                                NULL),
