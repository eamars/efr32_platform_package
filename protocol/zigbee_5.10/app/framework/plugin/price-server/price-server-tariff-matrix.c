                                     ...
                                     const EmberAfScheduledTariff *newTariff)
{
  ...
  if (update) {
    emberAfPluginPriceCommonSort((EmberAfPriceCommonInfo *)&info.scheduledTariffTable.commonInfos[ep],
                                 (uint8_t *)&info.scheduledTariffTable.scheduledTariffs[ep],
                                 sizeof(EmberAfScheduledTariff),
                                 EMBER_AF_PLUGIN_PRICE_SERVER_TARIFF_TABLE_SIZE);
                                ...
                                const EmberAfScheduledPriceMatrix *pm)
{
  ...
  if (index < EMBER_AF_PLUGIN_PRICE_SERVER_TARIFF_TABLE_SIZE) {
    ...
    emberAfPluginPriceCommonSort((EmberAfPriceCommonInfo *)&info.scheduledPriceMatrixTable.commonInfos[ep],
                                 (uint8_t *)&info.scheduledPriceMatrixTable.scheduledPriceMatrix[ep],
                                              ...
                                              uint8_t* payload)
{
  ...
  tableIndex = emberAfPluginPriceCommonGetCommonMatchingOrUnusedIndex(info.scheduledBlockThresholdsTable.commonInfos[ep],
                                                                      EMBER_AF_PLUGIN_PRICE_SERVER_TARIFF_TABLE_SIZE,
                                                                      issuerEventId,
                                                                      startTime,
                                                                      false);
...
bool emberAfPriceSetBlockThresholdsTableEntry(uint8_t endpoint,
                                              uint8_t index,
                                              const EmberAfPriceCommonInfo *newInf,
                                              const EmberAfScheduledBlockThresholds *bt)
{
  ...
  if (index < EMBER_AF_PLUGIN_PRICE_SERVER_TARIFF_TABLE_SIZE) {
    inf = &info.scheduledBlockThresholdsTable.commonInfos[ep][index];
    blockThresholds = &info.scheduledBlockThresholdsTable.scheduledBlockThresholds[ep][index];

    if (bt == NULL || newInf == NULL) {
      inf->valid = false;
    ...
    emberAfPluginPriceCommonSort((EmberAfPriceCommonInfo *)&info.scheduledBlockThresholdsTable.commonInfos[ep],
                                 (uint8_t *)&info.scheduledBlockThresholdsTable.scheduledBlockThresholds[ep],
                                 sizeof(EmberAfScheduledBlockThresholds),
                                 EMBER_AF_PLUGIN_PRICE_SERVER_TARIFF_TABLE_SIZE);
    emberAfPriceClusterScheduleTickCallback(endpoint,
