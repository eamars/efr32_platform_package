...
// *******************************************************************
#ifndef _PRICE_SERVER_H_
#define _PRICE_SERVER_H_
 ...
 *
 * @param endpoint The relevant endpoint.
 * @param repeat   Whether or not to try to repeat the current block period
 ...
 * If the force argument is set to true, then the billing period will be forced to refresh.
 *
 * @param endpoint The endpoint in question
