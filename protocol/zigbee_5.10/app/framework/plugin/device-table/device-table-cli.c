...
{
  switch (state) {
    case EMBER_AF_PLUGIN_DEVICE_TABLE_STATE_JUST_JOINED:
    case EMBER_AF_PLUGIN_DEVICE_TABLE_STATE_HAVE_ACTIVE:
    case EMBER_AF_PLUGIN_DEVICE_TABLE_STATE_HAVE_EP_DESC:
      emberAfCorePrint(" JOINING");
      break;
