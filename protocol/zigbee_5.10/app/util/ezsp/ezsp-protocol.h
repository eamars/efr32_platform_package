...
//   <sequence:1>
//   <frame control:1>
//   <extended frame ID (0xFF):1>
//   <extended frame control:1>
//   <extended frame ID:1>
//   <parameters:0-120>
//
...
#define EZSP_PROTOCOL_VERSION     0x05

#define EZSP_MIN_FRAME_LENGTH     3
// EZSP max length + Extended FC + Secure EZSP autentication header + Frame ID + Secure EZSP MIC
...
//------------------------------------------------------------------------------
// Extended Frame Control Definitions

// The high bit of the frame control byte indicates whether security is
// enabled or not.
...
// The 6th bit of the frame control byte indicates whether padding is
// enabled or not.
...
// Reserved bits 0-5
#define EZSP_EXTENDED_FRAME_CONTROL_RESERVED_MASK  0x3F
