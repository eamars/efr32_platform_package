...
enum {
  ...
  // Whether the NCP has updated Green Power support. Both host and NCP software
  // must be updated to fully support Green Power Proxy Basic functionality.
  // The 5.10.1 host software calls new EZSP functions for Green Power.  If this
  // configuration value is not present, the host will not call the new
  // functions.
  EZSP_CONFIG_GREEN_POWER_ACTIVE                = 0x37
};
#define EZSP_CONFIG_ID_MAX  0x37
