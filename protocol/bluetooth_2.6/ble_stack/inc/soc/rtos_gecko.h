...
void rtos_gecko_handle_command(uint32_t,void*);
void rtos_gecko_handle_command_noresponse(uint32_t,void*);
...
static inline void* gecko_cmd_dfu_reset(uint8 dfu)
{
	...
	rtos_gecko_handle_command_noresponse(gecko_cmd_msg->header,&gecko_cmd_msg->data.payload);
...
static inline struct gecko_msg_dfu_flash_set_address_rsp_t* gecko_cmd_dfu_flash_set_address(uint32 address)
{
    ...
    rtos_gecko_handle_command(gecko_cmd_msg->header,&gecko_cmd_msg->data.payload);
