...
#ifndef __EMBER_DUTY_CYCLE_H__
#define __EMBER_DUTY_CYCLE_H__

/**
 * @brief Per device duty cycle monitor feature limits to 32 connected end devices
 *    (excluding a local device).
 */
#define EMBER_MAX_CHILDREN_FOR_PER_DEVICE_DUTY_CYCLE_MONITOR (EMBER_MAX_END_DEVICE_CHILDREN > 32 \
