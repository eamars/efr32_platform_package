 ...
 */
#define EMBER_ALL_SUBGHZ_CHANNELS_MASK_FOR_PAGES_29 0xFF

/**
 * @brief The maximum subghz channel number on page 29 is 7.
 */
#define EMBER_MAX_SUBGHZ_CHANNEL_NUMBER_ON_PAGE_29   7
...
#ifdef DOXYGEN_SHOULD_SKIP_THIS
enum EmberAPSRetryPolicy
#else
typedef uint8_t EmberAPSRetryPolicy;
enum
#endif
{
  EMBER_NORMAL                   = 0x00,// APS_OPTIONS will define the policy
  EMBER_ALWAYS_RETRY             = 0x01,/* even if aps message does not require
                                           ACKs, we still try to send the message once more (EMZIGBEE-1034) */
};
