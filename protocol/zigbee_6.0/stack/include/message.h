...
/** @brief this function is used to set aps retry policy
 *  currently it could be set to EmberAPSRetryPolicy:
 *  - normal to simply follow the aps-options in a message
 *  - always retry atleast once
 */

void emberSetAPSRetryPolicy (EmberAPSRetryPolicy retryPolicy);

/** @brief this function is used to get aps retry policy
 *  it returns EmberAPSRetryPolicy:
 *  - normal to simply follow the aps-options in a message
 *  - always retry atleast once
 */

EmberAPSRetryPolicy emberGetAPSRetryPolicy (void);
...
/*
 * update the source route entry based on new information about the
 * change of child's parent
 */
 ...
 * @param index The index of source route table entry
 * @param The value of destination field in that entry
 * @param The value of closer Index entry field in that entry
 */
 ...
 * @param size Number of filled entries source route table
 */
 ...
 * @param size The total size of source route table
 */
 ...
 *
 * @param minAcksNeeded  The minimum number of acknowledgements (re-broadcasts)
