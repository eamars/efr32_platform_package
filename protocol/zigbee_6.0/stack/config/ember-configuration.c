...
EmberGpProxyTableEntry *emGpProxyTable = (EmberGpProxyTableEntry *) &emAvailableMemory[END_emRetryQueue];
uint8_t emGpProxyTableSize = EMBER_GP_PROXY_TABLE_SIZE;
#define END_emGpProxyTable \
  (END_emRetryQueue + align(EMBER_GP_PROXY_TABLE_SIZE * sizeof(EmberGpProxyTableEntry)))
...
//------------------------------------------------------------------------------
// Source routing
SourceRouteTableEntry *sourceRouteTable = (SourceRouteTableEntry *) &emAvailableMemory[END_emGpSinkTable];
                                              ...
                                              EmberNodeId parentOfNewNode)
{
  ...
  if (emberDefaultTrustCenterDecision != EMBER_DENY_JOIN
    ...
    emberChangeSourceRouteHandler(newNodeId, parentOfNewNode, false);
  }
#endif
...
#ifndef EMBER_APPLICATION_HAS_OUTGOING_COMMAND_HANDLER
...
#ifndef EMBER_APPLICATION_HAS_ZLL_NETWORK_RESPONSE_TEST_HANDLER
...
#ifndef EMBER_APPLICATION_HAS_ZLL_SEND_UNICAST_TEST_HANDLER
