// File: secure-ezsp-host.h
// Description: Secure EZSP API exposed to the Host
//
// Copyright 2007-2016 by Ember Corporation. All rights reserved.           *80*

#ifndef __SECURE_EZSP_HOST_H__
#define __SECURE_EZSP_HOST_H__
