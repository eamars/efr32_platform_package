// -----------------------------------------------------------------------------
// @file serial-interface-uart-config.h
...
// prevent compiler errors
  ...
  #endif
#endif
#endif //SERIAL_INTERFACE_UART_CONFIG_H
