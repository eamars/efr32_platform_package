// Copyright 2009-2017 Silicon Laboratories, Inc. All rights reserved.
//
                            ...
                            va_list argPointer)
{
  ...
  emAfApplyDisableDefaultResponse(&frameControl);
                                                       ...
                                                       ...)
{
  ...
  *emAfResponseLengthPtr = returnValue;
  ...
  emAfApplyRetryOverride(&emAfCommandApsFrame->options);
  return returnValue;
}
