...
#ifndef _PREPAYMENT_DEBT_LOG_H_
#define _PREPAYMENT_DEBT_LOG_H_

/**
 * @brief Initialize the debt log.
 *
 **/
...
/**
 * @brief Print the information in the debt log at the specified index.
...
/**
 * @brief Print the debt attribute set specified by the index parameter.
 * @param endpoint The endpoint number of the prepayment server.
...
/**
 * @brief Called to request sending a Publish Debt Log command.
 ...
 * @param latestEndTime The latest collection time of debt repayment records to be returned in the Publish Debt Log command.
