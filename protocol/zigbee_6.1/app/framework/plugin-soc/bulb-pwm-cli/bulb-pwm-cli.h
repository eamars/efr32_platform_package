...
#ifndef SILABS_BULB_PWM_CLI_PLUGIN_H
#define SILABS_BULB_PWM_CLI_PLUGIN_H
...
/** @brief Returns a true if the manufacturing library token has been set.
 *
 * Function to start the manufacturing library from the CLI.
 *
...
/** @brief Returns a true if the manufacturing library token has been set.
 *
 * Function to stop the manufacturing library from the CLI.
 *
 */
void emberAfMfglibStop(void);

/** @brief Returns the saved stastics from the RX test.
 *
 * Function to return the saved RX test statistics
 *
