...
// *
// * Copyright 2010-2017 by Ember Corporation. All rights reserved.              *80*
// *****************************************************************************
...
static uint32_t page28to31mask[EMBER_MAX_SUGBHZ_PAGE_NUMBER - EMBER_MIN_SUGBHZ_PAGE_NUMBER + 1] = {
  EMBER_ALL_SUBGHZ_CHANNELS_MASK_FOR_PAGES_28_30_31,    // page 28 mask
  EMBER_ALL_SUBGHZ_CHANNELS_MASK_FOR_PAGES_29,          // page 29 mask
  EMBER_ALL_SUBGHZ_CHANNELS_MASK_FOR_PAGES_28_30_31,    // page 30 mask
  EMBER_ALL_SUBGHZ_CHANNELS_MASK_FOR_PAGES_28_30_31     // page 31 mask
};
...
#if defined(EMBER_AF_HAS_COORDINATOR_NETWORK) && defined(EMBER_AF_PLUGIN_SUB_GHZ_SERVER)
...
EmberStatus emberAfSetFormAndJoinChannelMask(uint8_t page, uint32_t mask)
{
  switch (page) {
    ...
    case 29:
      ...
      page28to31mask[page - EMBER_MIN_SUGBHZ_PAGE_NUMBER] = mask;
      break;
#endif // defined(EMBER_AF_PLUGIN_SUB_GHZ_CLIENT) || defined(EMBER_AF_PLUGIN_SUB_GHZ_SERVER)
    default:
