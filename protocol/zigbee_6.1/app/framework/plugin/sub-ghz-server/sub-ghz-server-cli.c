...
PGM_P emAfSubGhzServerCliChannelChangeSetArguments[] = {
  "Channel change attribute (bit mask)",
  NULL
};

PGM_P emAfSubGhzServerCliChannelMaskSetArguments[] = {
  "Channel 28 mask",
  "Channel 29 mask",
  "Channel 30 mask",
  "Channel 31 mask",
...
PGM_P emAfSubGhzServerCliDutyCycleLimitsSetArguments[] = {
...
PGM_P emAfSubGhzServerCliSuspendZclMessagesArguments[] = {
...
PGM_P emAfSubGhzServerCliClientStatusArguments[] = {
  "Node ID of the given client",
  NULL
};
 ...
 */
static void printAttributes(PGM uint16_t attributeIds[], int n)
{
 ...
 */
static void setAttributes(PGM uint16_t attributeIds[], int n)
{
  const uint8_t endpoint = emberAfPrimaryEndpointForCurrentNetworkIndex();
  uint32_t      value;
  int           i;
 ...
 */
static PGM uint16_t ChannelChangeAttribs[] = {
 ...
 */
static PGM uint16_t ChannelMaskAttribs[] = {
...
void emAfSubGhzServerCliDutyCycleLimitsPrint(void)
{
  ...
  if (emberGetDutyCycleLimits(&limits) == EMBER_SUCCESS) {
    ...
    emberAfCorePrint("%p%p%p%p", "Could not get ", "", "duty cycle", " limits");
  }
  ...
  if (emberGetCurrentDutyCycle(sizeof arrayOfDutyCycles / sizeof arrayOfDutyCycles[0],
    ...
    emberAfCorePrint("%p%p%p%p", "Could not get ", "consumed ", "duty cycle", "s");
  }

  if (emberGetDutyCycleState(&dcState) == EMBER_SUCCESS) {
    emberAfCorePrintln("DC state: %s", dcStateStr[dcState]);
  } else {
    emberAfCorePrint("%p%p%p%p", "Could not get ", "current ", "duty cycle", " state");
  }
}
