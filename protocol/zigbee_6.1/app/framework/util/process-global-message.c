...
#include "afv2-bookkeeping.h" // emAfRetrieveAttributeAndCraftResponse
...
bool emAfProcessGlobalCommand(EmberAfClusterCommand *cmd)
{
  ...
  switch (zclCmd) {
    ...
    case ZCL_DISCOVER_ATTRIBUTES_EXTENDED_COMMAND_ID:
    {
      ...
      if (zclCmd == ZCL_DISCOVER_ATTRIBUTES_EXTENDED_RESPONSE_COMMAND_ID
