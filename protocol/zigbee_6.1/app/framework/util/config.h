...
// //
  ...
  #define EMBER_AF_DEFAULT_RESPONSE_POLICY_RESPONSES 0
    ...
    #define REJOIN_ON_REBOOT EMBER_NETWORK_INIT_END_DEVICE_REJOIN_ON_REBOOT
  #else
    #define REJOIN_ON_REBOOT EMBER_NETWORK_INIT_NO_OPTIONS
  #endif
  #if EMBER_SUPPORTED_NETWORKS == 1
    #if defined(EMBER_AF_PLUGIN_END_DEVICE_SUPPORT_ENHANCED_SLEEP_SUPPORT) && !defined(EZSP_HOST)
      #define EMBER_AF_CUSTOM_NETWORK_INIT_OPTIONS EMBER_NETWORK_INIT_PARENT_INFO_IN_TOKEN | REJOIN_ON_REBOOT
    #else
