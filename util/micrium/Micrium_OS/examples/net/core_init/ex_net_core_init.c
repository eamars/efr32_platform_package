...
*                                           Ex_Net_CoreInit()
*
* Description : Initialize the Network TCP-IP core and add an Ethernet Interface and/or a WiFi Interface.
*
* Argument(s) : None.
*
* Return(s)   : None.
...
*                                        Ex_Net_CoreStartWiFi()
*
* Description : Start an WiFi Interface.
*
* Argument(s) : None.
*
* Return(s)   : None.
*
* Note(s)     : (1) In this example no NET_IF_WIFI_CFG structure is passed to the start function.
*                   Therefore, no address setup is done by the start function and it must be done
*                   explicitly with DHCP client, IPv4 and IPv6 API calls, and after the call to
*                   NetIF_Ether_Start().
*********************************************************************************************************
