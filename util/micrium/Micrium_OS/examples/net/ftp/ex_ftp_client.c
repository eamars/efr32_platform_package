...
*                                           FTP EXAMPLE CODE
*
* File : ex_ftp_client.c
*********************************************************************************************************
* Note(s) : (1) For additional details on the features available with Micrium OS FTP Client, the
*               API, the installation, etc. Refer to the Micrium OS FTP Client documentation
...
#include  <rtos/net/include/ftp_client.h>
...
*
* Description : Send data to a file to the FTP server.
*
* Argument(s) : None.
*
* Return(s)   : None.
...
*
* Description : Download a file in a local buffer.
*
* Argument(s) : None.
*
* Return(s)   : None.
...
*                                  Ex_FTP_Client_FS_MediaPrepare()
*
* Description : Example of File System media preparation to contain FTP Client example files.
*
* Argument(s) : None.
*
* Return(s)   : None.
