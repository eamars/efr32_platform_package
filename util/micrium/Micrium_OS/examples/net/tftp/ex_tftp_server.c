...
*********************************************************************************************************
*
*                                      TFTP SERVER EXAMPLE CODE
*
* File : ex_tftp_server.c
*********************************************************************************************************
* Note(s) : (1) For additional details on the features available with Micrium OS TFTP Server, the
*               API, the installation, etc. Refer to the Micrium OS TFTP Server documentation
...
#include  <rtos/net/include/tftp_server.h>
