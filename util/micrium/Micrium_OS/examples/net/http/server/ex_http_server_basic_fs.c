...
*********************************************************************************************************
*
*                             HTTP SERVER INSTANCE BASIC WITH FS EXAMPLE
*
* File : ex_http_server_basic_fs.c
*********************************************************************************************************
* Note(s) : (1) This example shows how to initialize Micrium OS HTTP Server, initialize a web
*               server instance and start it.
*
*           (2) This example requires Micrium OS File System module.
*
*           (3) This file is an example about how to use Micrium OS HTTP Server, It may not cover
*               all case needed by a real application. Also some modification might be needed,
*               insert the code to perform the stated actions wherever 'TODO' comments are found.
*
...
*
* Description : Initializes and starts a basic web server instance. Retrieves WebServer files using
...
*
* Description : Example of Filse System media preparation to contain web files.
*
* Argument(s) : None.
*
* Return(s)   : None.
...
*                                        Ex_HTTPs_FS_FileAdd()
*
* Description : Create a files and copy contenmt to it from C array.
*
* Argument(s) : wrk_dir_handle      Handle on working directory.
*
*               p_file_name         String containing name of the file.
*
*               p_file_content      Pointer to content of file.
*
*               file_len            Length of file, in octets.
*
* Return(s)   : None.
*
* Note(s)     : None.
