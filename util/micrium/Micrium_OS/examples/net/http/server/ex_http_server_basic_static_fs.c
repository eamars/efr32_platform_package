...
*********************************************************************************************************
*
*                          HTTP SERVER INSTANCE BASIC WITH STATIC FS EXAMPLE
*
* File : ex_http_server_basic_static_fs.c
*********************************************************************************************************
...
*
*           (3) This file is an example about how to use the HTTP Server module, It may not cover
...
const  HTTPs_HOOK_CFG  Ex_HTTP_Server_HooksBasic =
{
...
void  Ex_HTTP_Server_InstanceCreateStaticFS (void)
{
   ...
   ((HTTPs_CFG_FS_STATIC *)p_cfg_http->FS_CfgPtr)->FS_API_Ptr                    = &HTTPs_FS_API_Static;
    ...
    p_cfg_http->HooksPtr                                                         = &Ex_HTTP_Server_HooksBasic;
    p_cfg_http->Hooks_CfgPtr                                                     =  DEF_NULL;

    Str_Copy_N(&Ex_HTTPs_Name[0], "Basic with Static FS", 60);
