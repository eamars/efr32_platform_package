...
*
* Description : Send a GET request without using the HTTP client internal task and retrieve the HTTP
*               response.
*
* Argument(s) : None.
*
...
*
* Description : Send a GET request with a Query String and additional headers.
*
* Argument(s) : None.
*
* Return(s)   : None.
...
*
* Description : Send an Application type form.
*
* Argument(s) : None.
*
* Return(s)   : None
...
*
* Argument(s) : p_wrk_dir   String that contains the directory where the index.html file to send as part
...
*                                  Ex_HTTP_Client_FS_MediaPrepare()
*
* Description : Example of File System media preparation to contain HTTP Client example files.
*
* Argument(s) : None.
*
* Return(s)   : None.
...
*                           present or if no file is desired as part of the form.
*
*               p_form_tbl  Variable that will received the pointer to the form table.
*
* Return(s)   : Number of fields in the form table.
*
* Note(s)     : None.
