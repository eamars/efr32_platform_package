...
#elif defined(RTOS_MODULE_NET_SSL_TLS_MOCANA_NANOSSL_AVAIL)
...
/* The follwoing alternative CA certificates in Mocana NanoSSL-ready format are provided for your convenience */
...
/* For Mocana, the size must not include the null terminating character */
const  CPU_INT32U  SSL_CA_Cert_Len   = sizeof(SSL_CA_CERT)      - 1;
const  CPU_INT32U  SSL_ServerCertLen = sizeof(SSL_SERVER_CERT)  - 1;
const  CPU_INT32U  SSL_ServerKeyLen  = sizeof(SSL_SERVER_KEY)   - 1;
const  CPU_INT32U  SSL_ClientCertLen = sizeof(SSL_CLIENT_CERT)  - 1;
const  CPU_INT32U  SSL_ClientKeyLen  = sizeof(SSL_CLIENT_KEY)   - 1;
