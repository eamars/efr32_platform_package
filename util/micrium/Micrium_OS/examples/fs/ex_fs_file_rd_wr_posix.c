...
*
* Description : Perform file read/write example with the Posix API.
*
* Argument(s) : none.
*
* Return(s)   : none.
...
* Return(s)   : none.
*
* Note(s)     : (1)  This example writes data to the file in one shot. It does NOT support writing a file
