...
#error "File multi-descriptor example requires OS_CFG_SEM_DEL_EN set to DEF_ENABLED in os_cfg.h."
#endif
...
*                                        Ex_FS_FileMultiDesc()
*
* Description : Perform file multi-descriptor example.
*
* Argument(s) : none.
*
* Return(s)   : none.
...
*
* Description : This example will do the following main steps:
*
...
*
*               p_file_name     Pointer to file name.
*
...
* Return(s)   : none.
*
* Note(s)     : (1) If the media type is a RAM disk, the maximum number of logical block counts used
...
*                                            Ex_FS_TaskRd()
*
* Description : Task that reads some data from a specified file and verify the data read. This task works
*               with a Writer task represented by the function Ex_FS_FileMultiDesc_Exec().
*
* Argument(s) : p_arg   Pointer to argument passed to the task upon its creation.
*
* Return(s)   : none.
*
* Note(s)     : none.
