...
#include  <rtos/fs/include/fs_core_working_dir.h>
...
*                                           Ex_FS_EntryPath()
*
* Description : Perform file path example.
*
* Argument(s) : none.
*
* Return(s)   : none.
...
* Return(s)   : none.
*
* Note(s)     : (1) When using working directories, any path specified with a working directory handle
*                   are considered as relative. As opposed to absolute paths which use a NULL working
*                   directory handle.
*
*
*               (2) Virtual root directory refers to the media name level. Let's assume for instance the
