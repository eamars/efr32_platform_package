...
*                                          USB HOST EXAMPLE
*
*                        Human Interface Device (HID) - Mouse/keyboard example
*********************************************************************************************************
...
#include  <rtos/usb/include/host/usbh_hid.h>
...
*                                        Ex_USBH_HID_OnDataRxd()
*
* Description : This function is called when a report is received from an HID function.
*
* Argument(s) : hid_fnct_handle     Handle on HID function.
*
*               p_arg               Argument associated to HID function returned to function
*                                   Ex_USBH_HID_Conn().
*
*               report_id           ID of received report.
*
*               p_buf               Pointer to buffer containing report.
*
...
*
* Description : This function is called when an HID function is disconnected.
*
* Argument(s) : hid_fnct_handle     Handle on HID function.
*
*               p_arg               Argument associated to HID function returned to function
...
*
* Description : New mouse position received. Update absolute position.
*
...
*
* Description : Print pressed keyboard keys.
*
* Argument(s) : p_buf       Pointer to keyboard report buffer.
*
