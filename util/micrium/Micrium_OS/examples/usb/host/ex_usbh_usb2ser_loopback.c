...
#include  <rtos/usb/include/host/usbh_usb2ser.h>
...
*
* Description : Example of initialization of the USB2SER class driver. Also creates the required tasks
...
*                                    Ex_USBH_USB2SER_LoopbackConn()
*
* Description : A USB2SER function has been connected.
*
* Argument(s) : dev_handle              Handle on USB device.
*
*               fnct_handle             Handle on USB function.
*
*               usb2ser_fnct_handle     Handle on USB2SER class function handle.
*
* Return(s)   : Pointer to application specific data associated to USB2SER function.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*                                    Ex_USBH_USB2SER_LoopbackDisconn()
*
* Description : A USB2SER function has been disconnected.
*
* Argument(s) : usb2ser_fnct_handle     Handle on USB2SER class function handle.
*
...
*                                    Ex_USBH_USB2SER_LoopbackDataRxd()
*
* Description : A USB2SER function has received new data.
*
* Argument(s) : usb2ser_fnct_handle     Handle on USB2SER class function handle.
*
*               p_arg                   Pointer to application specific data associated to USB2SER
*                                       function returned to Ex_USBH_USB2SER_LoopbackConn().
*
*               p_buf                   Pointer to buffer containing the received data.
*
*               buf_len                 Buffer length in octets.
*
* Return(s)   : None.
*
* Note(s)     : (1) It is not a good practice to attempt communication in this callback. Processing done
...
*                                Ex_USBH_USB2SER_LoopbackSerialStatusChng()
*
* Description : A USB2SER function's serial status has changed.
*
* Argument(s) : usb2ser_fnct_handle     Handle on USB2SER class function handle.
*
*               p_arg                   Pointer to application specific data associated to USB2SER
*                                       function returned to Ex_USBH_USB2SER_LoopbackConn().
*
*               serial_status           New serial status.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*
* Description : This function is called once data transmission is completed.
*
* Argument(s) : usb2ser_fnct_handle     Handle on USB2SER function.
*
*               p_arg                   Pointer to argument passed to USBH_USB2SER_TxAsync().
*
...
*                                 Ex_USBH_USB2SER_LoopbackTaskHandler()
*
* Description : Loopback task handler.
*
