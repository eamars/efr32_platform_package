...
*                                          USB HOST EXAMPLE
*
*                               CDC Abstract Control Model - Modem example
*********************************************************************************************************
...
#include  <rtos/usb/include/host/usbh_cdc.h>
#include  <rtos/usb/include/host/usbh_acm.h>
...
*
* Description : Example of initialization of the CDC ACM class driver.
*
* Argument(s) : None.
*
* Return(s)   : None.
...
*                                    Ex_USBH_CDC_ACM_ModemConn()
*
* Description : A CDC ACM function has been connected.
*
* Argument(s) : dev_handle          Handle on USB device.
*
*               fnct_handle         Handle on USB function.
*
*               cdc_fnct_handle     Handle on CDC class function handle.
*
*               acm_fnct_handle     Handle on ACM subclass function handle.
*
* Return(s)   : Pointer to application specific data associated to CDC ACM function.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*                                     Ex_USBH_CDC_ACM_ModemDisconn()
*
* Description : A CDC ACM function has been disconnected.
*
* Argument(s) : acm_fnct_handle     Handle on CDC ACM class function handle.
*
*               p_arg               Pointer to application specific data associated to CDC ACM
...
*                                      Ex_USBH_CDC_ACM_ModemNetConn()
*
* Description : A CDC ACM modem network connection state has changed.
*
* Argument(s) : acm_fnct_handle     Handle on CDC ACM class function handle.
*
*               p_arg               Pointer to application specific data associated to CDC ACM
*                                   function returned to Ex_USBH_CDC_ACM_ModemConn().
*
*               is_conn             Indicates if device connected to network or not.
...
*                                    Ex_USBH_CDC_ACM_ModemRespAvail()
*
* Description : A CDC ACM Modem response is available.
*
* Argument(s) : acm_fnct_handle     Handle on CDC ACM class function handle.
*
*               p_arg               Pointer to application specific data associated to CDC ACM
...
*                                      Ex_USBH_CDC_ACM_ModemSerialStateChng()
*
* Description : CDC ACM serial state has changed.
*
* Argument(s) : acm_fnct_handle     Handle on CDC ACM class function handle.
*
*               p_arg               Pointer to application specific data associated to USB2SER
*                                   function returned to Ex_USBH_USB2SER_LoopbackConn().
*
*               serial_state        New serial state bitmap.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*                                  Ex_USBH_CDC_ACM_ModemTaskHandler()
*
* Description : CDC ACM modem example task handler.
*
* Argument(s) : p_arg       Task argument.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*                                     Ex_USBH_CDC_ACM_ModemTxCmpl()
*
* Description : Data transmission to CDC ACM function completed.
*
* Argument(s) : acm_fnct_handle     Handle on CDC ACM function.
*
*               p_buf               Pointer to transmitted buffer.
*
*               buf_len             Length, in octets, of submitted buffer.
*
*               xfer_len            Length, in octets, of transmitted buffer.
*
*               p_arg               Pointer to application argument passed to USBH_ACM_TxAsync().
*
*               err                 Error code indicating if transfer was successful.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*                                     Ex_USBH_CDC_ACM_ModemRxCmpl()
*
* Description : Data reception from CDC ACM function completed.
*
* Argument(s) : acm_fnct_handle     Handle on CDC ACM function.
*
*               p_buf               Pointer to reception buffer.
*
*               buf_len             Length, in octets, of submitted buffer.
*
*               xfer_len            Length, in octets, of received buffer.
*
*               p_arg               Pointer to application argument passed to USBH_ACM_RxAsync().
*
*               err                 Error code indicating if transfer was successful.
*
* Return(s)   : None.
