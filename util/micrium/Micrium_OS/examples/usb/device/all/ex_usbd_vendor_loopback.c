...
#include  <rtos/usb/include/device/usbd_vendor.h>
...
*
* Description : This function is called when a vendor specific request is received from the host. This
*               function can be ommited if no vendor specific request is used.
*
* Argument(s) : class_nbr       Class number.
*
*               dev_nbr         Device number.
*
*               p_setup_req     Pointer to setup request buffer.
*
* Return(s)   : DEF_OK:   Operation succeeded.
*               DEF_FAIL: Otherwise.
*
...
*               DEF_FAIL, otherwise.
*
* Caller(s)   : Ex_USBD_Vendor_LoopbackEchoSyncTask().
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*                                 Ex_USBD_Vendor_LoopbackAsyncTask()
*
* Description : Perform loopback demo with asynchronous communication (see Note #1):
*
*                   (a) Read header.
*                   (b) Read payload of a certain size.
*                   (c) Write payload previously received.
