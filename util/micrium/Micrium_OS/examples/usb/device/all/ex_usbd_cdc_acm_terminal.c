...
*                                         USB DEVICE EXAMPLE
*
*                                   USB CDC Abstract Control Model
*
...
#include  <rtos/usb/include/device/usbd_cdc_acm_serial.h>
...
*
* Description : Adds a CDC ACM interface to the device and creates a task to handle the terminal
*               functionnalities.
*
...
*                                   Ex_USBD_CDC_ACM_TerminalTask()
*
* Description : USB CDC ACM terminal emulation demo task.
*
...
*
* Note(s)     : (1) This task manages the display of the terminal in according to the user's inputs.
*********************************************************************************************************
*/
...
* Return(s)   : None.
*
* Caller(s)   : CDC ACM subclass.
*
* Note(s)     : (1) This callback is optional.
*********************************************************************************************************
*/
