...
*                                         USB DEVICE EXAMPLE
*
*                               USB MSC Logical Unit Add - File System
*********************************************************************************************************
*/
...
#include  <rtos/usb/include/device/usbd_msc.h>
#include  <rtos/fs/include/fs_core.h>
#include  <rtos/usb/include/device/usbd_scsi_storage_blk_dev.h>
#include  <rtos/fs/include/fs_ramdisk.h>
#include  <rtos/fs/include/fs_storage.h>
...
*                                           Ex_USBD_MSC_Init()
*
* Description : Adds an MSC interface to the device and adds a logical unit to it. The logical unit uses
...
* Return(s)   : None.
*
* Note(s)     : (1) Using the refresh task is recommended when using uC/RTOS-FS storage driver. It is
...
*
* Description : Logical unit host eject event callback.
*
* Argument(s) : lu_nbr  Logical unit number.
*
* Return(s)   : None.
*
* Caller(s)   : MSC.
*
* Note(s)     : (1) This function will be called when an eject operation is performed from the host.
*********************************************************************************************************
*/
