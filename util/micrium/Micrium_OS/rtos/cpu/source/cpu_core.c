...
*                                              CPU_Init()
*
* Description : Initialize CPU module :
*
...
* Return(s)   : None.
*
* Note(s)     : (1) CPU_Init() MUST be called ... :
*
...
*                                              CPU_Break()
*
* Description : If the port does not define a CPU_Break() function, emulate the break with a software
...
* Return(s)   : None.
*
* Note(s)     : (1) See 'cpu.h  CPU_BREAK()  Note #1'.
*********************************************************************************************************
*/
...
*
*                       See also 'cpu.h  FUNCTION PROTOTYPES  CPU_TS_TmrRd()  Note #2c2'.
*********************************************************************************************************
*/
...
*
*                           See also 'cpu.h  FUNCTION PROTOTYPES  CPU_TSxx_to_uSec()  Note #2a'.
*
...
*
*                       See also 'cpu.h  FUNCTION PROTOTYPES  CPU_TSxx_to_uSec()  Note #2b'.
*********************************************************************************************************
*/
...
* Return(s)   : None.
*
* Note(s)     : (1) This function is an INTERNAL CPU module function and your application MUST NOT call it.
*********************************************************************************************************
*/
...
*
*                               See also 'cpu.h  FUNCTION PROTOTYPES  CPU_TS_TmrRd()  Note #2a'.
*
...
*
*                               See also 'cpu.h  FUNCTION PROTOTYPES  CPU_TS_TmrRd()  Note #2b'.
*
...
*
*               (2) This function is an INTERNAL CPU module function and your application MUST NOT call it.
*********************************************************************************************************
*/
...
* Return(s)   : None.
*
* Note(s)     : (1) CPU_IntDisMeasInit() SHOULD precede ALL calls to CPU_CRITICAL_ENTER()/CPU_CRITICAL_EXIT()
...
*
*               (2) (a) (1) Interrupts disabled time measurement overhead performed multiple times to calculate
...
static  void  CPU_IntDisMeasInit (void)
{
    ...
    CPU_INT_DIS();                                              /* Ints MUST be dis'd for ovrhd calc (see Note #2b).    */
    for (i = 0u; i < CPU_CFG_INT_DIS_MEAS_OVRHD_NBR; i++) {
        ...
        time_meas_tot_cnts += CPU_IntDisMeasMaxCur_cnts;        /* ...       & sum time meas max's                  ... */
                                                                ...
                                                                /* ... to calc avg time meas ovrhd (see Note #2a).      */
