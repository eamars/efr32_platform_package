...
*
* Note(s) : (1) Configure CPU_CFG_ADDR_SIZE & CPU_CFG_DATA_SIZE in 'cpu_port.h' with CPU's word sizes :
*
...
*
*           (2) Configure CPU_CFG_ENDIAN_TYPE in 'cpu_port.h' with CPU's data-word-memory order :
*
...
*                        if used, MUST be declared following ALL other local variables (see any 'cpu_port.h
