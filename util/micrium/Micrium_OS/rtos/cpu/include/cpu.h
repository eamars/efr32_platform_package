...
#error  "CPU_CFG_DATA_SIZE illegally #defined in 'cpu_port.h'. [See 'cpu_port.h  CONFIGURATION ERRORS']."
...
*                                              CPU_BREAK()
*
* Description : Create software generated break.
*
* Argument(s) : None.
*
* Return(s)   : None.
*
* Note(s)     : (1) CPU_BREAK() is used to create a CPU break.
*********************************************************************************************************
*/
...
*
* Description : Obtain the minimum data alignment, in bytes.
*
* Argument(s) : None.
*
* Return(s)   : Minimum data alignment, in bytes, required by the CPU.
*
* Note(s)     : (1) CPU_MIN_DATA_ALIGN_BYTES() can be implemented as a function in the port if the
...
*
* Argument(s) : err_rtn_val     Error type &/or value of the calling function to return.
*
* Return(s)   : None.
*
...
*                                           CPU_VAL_UNUSED()
*
* Description : DEPRECATED. Macro used to prevent compiler warnings for unused parameters and variables.
*
* Argument(s) : val     variable or parameter generating the warning.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*
*               (3) This function is an INTERNAL CPU module function and your application MUST NOT call it.
*********************************************************************************************************
*/
...
*
*               (3) This function is an INTERNAL CPU module function and your application MAY call it.
*********************************************************************************************************
*/
...
#if 0                                                           /* Optionally configured in 'cpu_cfg.h'; DO NOT MODIFY. */
#error  "CPU_CFG_LEAD_ZEROS_ASM_PRESENT not #define'd in 'cpu_port.h'/'cpu_cfg.h'"
#endif
#endif
...
#if 0                                                           /* Optionally configured in 'cpu_cfg.h'; DO NOT MODIFY. */
#error  "CPU_CFG_TRAIL_ZEROS_ASM_PRESENT not #define'd in 'cpu_port.h'/'cpu_cfg.h'"
#endif
#endif
