...
#include  <rtos/io/source/serial/serial_priv.h>
#include  <rtos/io/source/serial/serial_ctrlr_priv.h>
...
/*
*********************************************************************************************************
*                                      Serial_ConfigureMemSegPtr()
*
* Description : Configures memory segment to use for internal data allocations.
*
* Argument(s) : p_seg   Pointer to memory segment.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
#if (RTOS_CFG_EXTERNALIZE_OPTIONAL_CFG_EN == DEF_DISABLED)
void  Serial_ConfigureMemSegPtr (MEM_SEG  *p_seg)
{
...
*
* Description : Configure maximum number of serial handles.
*
* Argument(s) : handle_qty  Maximum number of serial handles.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*                                             Serial_Init()
*
* Description : Initializes the serial core module.
*
...
*                                           Serial_CtrlrAdd()
*
* Description : Adds a serial controller.
*
* Argument(s) : name    Name of serial controller.
*
*               mode    Serial mode that controller should use.
*
...
*                           RTOS_ERR_TIMEOUT
*
* Return(s)   : Handle to serial controller.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*
* Description : Gets required buffer alignment for specified serial controller.
*
* Argument(s) : name    Serial controller name.
*
* Return(s)   : Required buffer alignment, in octets.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*
* Description : Gets serial handle from controller's name.
*
* Argument(s) : name    Serial controller name.
*
* Return(s)   : Serial handle,     if exists.
...
*                                            Serial_Start()
*
* Description : Starts serial controller.
*
* Argument(s) : handle  Handle to serial controller.
*
*               mode    Mode in which serila controller should be started.
*
*                           SERIAL_CTRLR_MODE_UART
*                           SERIAL_CTRLR_MODE_SPI
*                           SERIAL_CTRLR_MODE_I2C
...
*                                             Serial_Stop()
*
* Description : Stops serial controller.
*
* Argument(s) : handle  Handle to serial controller.
*
*               p_err   Pointer to the variable that will receive one of the following error code(s) from
...
*                                            Serial_CfgChk()
*
* Description : Ensures serial configurations are supported by controller/driver.
*
* Argument(s) : handle  Handle to serial controller.
*
*               p_cfg   Pointer to serial configuration structure.
*
*               p_err   Pointer to the variable that will receive one of the following error code(s) from
*                       this function:
*
*                           RTOS_ERR_NONE
*
* Return(s)   : Flag indicating if serial configurations are supported.
*
...
*                                             Serial_Cfg()
*
* Description : Configures serial controller.
*
* Argument(s) : handle  Handle to serial controller.
*
*               p_cfg   Pointer to serial configuration structure.
...
*                                           Serial_SlaveSel()
*
* Description : Selects slave.
*
* Argument(s) : handle          Handle to serial controller.
*
*               p_slave_info    Pointer to slave information structure.
*
...
*
* Description : Sets dummy byte to send in RX only operation (for SPI mode).
*
* Argument(s) : handle          Handle to serial controller.
*
*               tx_dummy_byte   Dummy byte to transmit.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*                                              Serial_Rx()
*
* Description : Receives data from serial bus.
*
* Argument(s) : handle      Handle to serial controller.
*
...
*                                              Serial_Tx()
*
* Description : Transmits data to serial bus.
*
* Argument(s) : handle      Handle to serial controller.
*
...
*                                             Serial_Xfer()
*
* Description : Receives/transmits data from/to serial bus.
*
* Argument(s) : handle      Handle to serial controller.
*
*               p_rx_buf    Pointer to receive buffer.
*
*               p_tx_buf    Pointer to transmit buffer.
*
*               buf_len     Length of buffer, in octets.
*
*               timeout_ms  Timeout, in milliseconds.
*
*               p_err       Pointer to the variable that will receive one of the following error code(s)
...
*                                          Serial_LoopbackEn()
*
* Description : Enables/disables loopback mode (if possible) on serial controller.
*
* Argument(s) : handle  Handle to serial controller.
*
*               en      Flag inidicating if loopback mode should be enabled or disabled.
*
*               p_err   Pointer to the variable that will receive one of the following error code(s)
*                       from this function:
*
...
*                                         Serial_EventRxCmpl()
*
* Description : Callback called when data receive completed by driver.
*
* Argument(s) : handle  Handle to serial controller.
*
*               err     Error code.
...
*                                         Serial_EventTxCmpl()
*
* Description : Callback called when data transmit completed by driver.
*
* Argument(s) : handle  Handle to serial controller.
*
*               err     Error code.
