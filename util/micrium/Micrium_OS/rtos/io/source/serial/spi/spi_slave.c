...
*                                            SPI_SlaveOpen()
*
* Description : Opens/creates a slave on an SPI bus.
*
* Argument(s) : bus_handle      Handle on SPI bus.
*
...
*                                           SPI_SlaveClose()
*
* Description : Closes an SPI slave.
*
* Argument(s) : slave_handle    Handle on SPI slave.
*
*               p_err           Pointer to the variable that will receive one of the following error
*                               code(s) from this function:
*
...
*                                            SPI_SlaveSel()
*
* Description : Enables slave-select for the slave associated with 'handle'
*
...
*
*               opt             Options flags for slave-select. May be one of the following:
*
...
* Return(s)   : None.
*
* Note(s)     : (1) Enabling slave-select will lock the handle's SPI bus to the calling task, preventing
...
*                                           SPI_SlaveDesel()
*
* Description : Disables slave-select for the slave associated with 'slave_handle'.
*
* Argument(s) : slave_handle    Handle on an SPI slave.
*
*               p_err           Pointer to the variable that will receive one of the following error
*                               code(s) from this function:
*
...
*                                            SPI_SlaveRx()
*
* Description : Receives data from SPI slave.
*
* Argument(s) : slave_handle    Handle on an SPI slave.
*
...
*                                            SPI_SlaveTx()
*
* Description : Transmits data to SPI slave.
*
* Argument(s) : slave_handle    Handle on an SPI slave.
*
...
*                                           SPI_SlaveXfer()
*
* Description : Transmits and receives data to/from SPI slave.
*
* Argument(s) : slave_handle    Handle on an SPI slave.
*
