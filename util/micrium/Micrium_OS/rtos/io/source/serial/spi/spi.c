...
/*
*********************************************************************************************************
*                                       SPI_ConfigureMemSegPtr()
*
* Description : Sets the memory segment where file system internal data structures will be allocated.
*
* Argument(s) : p_seg   Pointer to a memory segment.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
#if (RTOS_CFG_EXTERNALIZE_OPTIONAL_CFG_EN == DEF_DISABLED)
void  SPI_ConfigureMemSegPtr  (MEM_SEG  *p_seg)
{
...
*
* Description : Configure the maximum number of SPI slave handles for all the SPI busses.
*
* Argument(s) : handle_qty      Max number of SPI slave handles.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
* Return(s)   : None.
*
* Note(s)     : (1) This function is NOT thread-safe and should be called ONCE during system
*                   initialization, before multi-threading has begun.
*
*               (2) This function will not return an error -- any error conditions will trigger a failed
*                   assertion.
*********************************************************************************************************
*/
