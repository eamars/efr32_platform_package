...
#include  <rtos/io/source/serial/spi/spi_priv.h>
...
*                                             SPI_BusAdd()
*
* Description : Creates/Adds SPI bus.
*
* Argument(s) : name    Name to give to the new bus. Must be unique, constant, and in scope for the
...
*
* Description : Gets SPI bus handle from serial controller name.
*
* Argument(s) : name    Serial controller name.
*
* Return(s)   : Bas handle,         if exists.
...
*                                            SPI_BusStart()
*
* Description : Starts given SPI bus/driver.
*
* Argument(s) : bus_handle  Handle to SPI bus.
*
*               p_err       Pointer to the variable that will receive one of the following error code(s)
*                           from this function:
*
...
*                                             SPI_BusStop()
*
* Description : Stops given SPI bus/driver.
*
* Argument(s) : bus_handle  Handle to SPI bus.
*
*               p_err       Pointer to the variable that will receive one of the following error code(s)
...
*                                           SPI_BusSlaveSel()
*
* Description : Enables slave-select and configures SPI bus for given slave. This will lock the bus,
*               preventing any other thread/slave from accessing it.
*
* Argument(s) : bus_handle      Handle to SPI bus.
*
*               slave_id        Slave identification number.
*
*               active_low      Flag that indicates if slave is active low or high.
*
*               p_ser_cfg       Pointer to structure containing serial configurations.
*
*               tx_dummy_byte   Dummy byte to transmit in RX only operations.
*
*               timeout         Timeout, in milliseconds.
*
*               is_nonblocking  Flag indicating if current call is non-blocking.
*
...
*                                          SPI_BusSlaveDesel()
*
* Description : Disables slave-select on the SPI bus.
*
* Argument(s) : bus_handle  Handle to SPI bus.
*
*               slave_id    Slave identification number.
*
*               active_low  Flag that indiciates of slave is active low or high.
*
*               p_err       Pointer to the variable that will receive one of the following error code(s)
*                           from this function:
*
...
*                                              SPI_BusRx()
*
* Description : Recevies data from SPI bus.
*
* Argument(s) : bus_handle  Handle to SPI bus.
*
...
* Return(s)   : None.
*
* Note(s)     : (1) This function assumes the SPI bus has been locked by the caller.
*********************************************************************************************************
*/
...
*                                              SPI_BusTx()
*
* Description : Transmits data to SPI bus.
*
* Argument(s) : bus_handle  Handle to SPI bus.
*
...
*                                             SPI_BusXfer()
*
* Description : Receives and transmits data from/to SPI bus.
*
* Argument(s) : bus_handle  Handle to SPI bus.
*
*               p_buf_rx    Pointer to receive buffer.
*
*               p_buf_tx    Pointer to transmit buffer.
*
*               buf_len     Length of buffer, in octets.
*
*               timeout_ms  Timeout, in milliseconds.
...
*                                          SPI_BusLoopBackEn()
*
* Description : Enables loopback on SPI bus via IO Ctrl.
*
* Argument(s) : bus_handle  Handle to SPI bus.
*
*               en          Flag indicating if loopback mode should be enabled or disabled.
*
*                               DEF_ENABLED
*                               DEF_DISABLED
*
...
*                                             SPI_BusLock()
*
* Description : Locks SPI bus.
*
* Argument(s) : bus_handle      Handle to SPI bus.
*
*               timeout         Timeout, in milliseconds.
*
*               is_nonblocking  Flag indicating if call should be blocking or not.
*
*               p_err           Pointer to the variable that will receive one of the following error
*                               code(s) from this function:
*
...
*                                           SPI_BusStateGet()
*
* Description : Gets current SPI bus state..
*
* Argument(s) : bus_handle  Handle to SPI bus.
*
* Return(s)   : Current SPI bus state.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*                                           SPI_BusStateSet()
*
* Description : Sets current SPI bus state.
*
* Argument(s) : bus_handle  Handle to SPI bus.
*
*               state       SPI bus state to set.
*
* Return(s)   : None.
*
* Note(s)     : None.
