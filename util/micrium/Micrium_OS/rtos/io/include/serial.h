...
*                                        IO_SERIAL_CTRLR_REG()
*
* Description : Registers a IO serial controller to the platform manager.
*
* Argument(s) : name        Unique name for the IO serial controller. It is recommended to follow the
*                           standard "serX", "spiX", "i2cX", "uartX" etc. where X is a digit.
*
*               p_drv_info  Pointer to the serial driver hardware information structure of type
*                           SERIAL_CTRLR_DRV_INFO.
*
* Return(s)   : None.
*
* Note(s)     : (1) This macro should normally be called from the BSP.
*********************************************************************************************************
*/
...
*
* Note(s) : (1) This structure should ONLY be instantiated via the macro IO_SERIAL_CTRLR_REG().
*********************************************************************************************************
*/
