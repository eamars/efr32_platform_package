...
* File : clk.h
*********************************************************************************************************
* Note(s) : (1) (a) Clock module is based on Coordinated Universal Time (UTC) and supports the following
...
*
*
*           (2) (a) Clock module implements a software-maintained clock/calendar when 'CLK_CFG_EXT_EN' is
*                   disabled.
*
*               (b) (1) Software-maintained clock/calendar is based on a periodic delay or timeout when
*                       'CLK_CFG_SIGNAL_EN' is disabled.
*
*                   (2) Software-maintained clock/calendar is based on a periodic signal or timer when
...
*
*
*           (3) (a) Clock module initializes, gets and sets its timestamp via an External timestamp when
*                   'CLK_CFG_EXT_EN' is enabled.
*
*               (b) (1) External timestamp can be maintained either in: hardware (e.g. via a hardware
...
*
*               (2) (a) External timestamp SHOULD be an 'up' counter whose values increase at each
...
*
*               (3) This function is an INTERNAL Clock module function & MUST be implemented by
...
*
*
*               (4) The Clock timestamp is calculated by one of the following equations (assuming Note
*                   #3b) :
*
...
*                                                       from UTC+00)
*
*               (5) This function is an INTERNAL Clock module function & MUST be implemented by
*                   application/BSP function(s) [see Note #1] but MUST NOT be called by application
*                   function(s).
*********************************************************************************************************
*/
...
*
*
*               (2) (a) External timestamp values are converted from Clock timestamp's 'CLK_TS_SEC' data
*                       type.
*
*                   (b) (1) If the External timestamp has more bits than the 'CLK_TS_SEC' data type,
...
*
*
*               (3) (a) External timestamp values MUST be converted from the reference of the Clock epoch
*                       start date/time.
*
*                   (b) External timestamp SHOULD start on midnight of January 1st of its epoch start
*                       year. Otherwise, the equations to convert between External timestamp & Clock
...
*
*
*               (4) The External timestamp is calculated by one of the following equations (assuming Note
*                   #3b) :
*
*                   (a) When External epoch start year is less than Clock epoch start year
*                       ('CLK_EPOCH_YR_START') :
