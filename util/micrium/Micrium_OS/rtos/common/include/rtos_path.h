...
#define  RTOS_CPU_PORT_NAME             RTOS_CPU_SEL_ARM_V5
       ...
       (RTOS_CPU_SEL == RTOS_CPU_SEL_TI_RM44LX)       || \
       (RTOS_CPU_SEL == RTOS_CPU_SEL_TI_RM46X)        || \
       (RTOS_CPU_SEL == RTOS_CPU_SEL_TI_RM48X)        || \
       (RTOS_CPU_SEL == RTOS_CPU_SEL_TI_RM57LX)       || \
       ...
       (RTOS_CPU_SEL == RTOS_CPU_SEL_TI_TMS570LS07x)  || \
       (RTOS_CPU_SEL == RTOS_CPU_SEL_TI_TMS570LS09x)  || \
       (RTOS_CPU_SEL == RTOS_CPU_SEL_TI_TMS570LS11x)  || \
       (RTOS_CPU_SEL == RTOS_CPU_SEL_TI_TMS570LS12x)  || \
       (RTOS_CPU_SEL == RTOS_CPU_SEL_TI_TMS570LS21x)  || \
       (RTOS_CPU_SEL == RTOS_CPU_SEL_TI_TMS570LS31x)  || \
       (RTOS_CPU_SEL == RTOS_CPU_SEL_TI_TMS570LC43x)  || \
...
#define  RTOS_INT_CONTROLLER_NAME       RTOS_INT_CONTROLLER_RX
       ...
       (RTOS_CPU_SEL == RTOS_CPU_SEL_TI_TMS570LS31x)  || \
       (RTOS_CPU_SEL == RTOS_CPU_SEL_TI_TMS570LC43x))
#define  RTOS_INT_CONTROLLER_NAME       RTOS_INT_CONTROLLER_ARMV7_AR_VIMX
