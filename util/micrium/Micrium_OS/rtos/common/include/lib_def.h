...
* File : lib_def.h
*********************************************************************************************************
* Note(s) : (1) This file is intended to regroup LIB capabilities that do not depend on CPU elements.
...
*                                        DEF_IS_ADDR_ALIGNED()
*
* Description : Determine if specified address is aligned.
*
* Argument(s) : addr        Memory address to evaluate.
*
*               align       Alignment needed (in bytes).
*
* Return(s)   : DEF_YES     Address is aligned.
*
*               DEF_NO      Address is not aligned.
*
* Note(s)     : (1) Align value MUST be a power of 2.
*********************************************************************************************************
*/
