...
*
* Description : Assert given expression. In case of failure, calls
...
*               if not.
*
* Argument(s) : expr        Expression to assert. If expression is false, the assert fail call will be
*                           made.
*
...
*
* Description : Checks if assert is enabled for current module. Calls END_CALL as configured by user. No
*               check is made.
*
* Argument(s) : ret_val     Value that would be returned from the function, ';' if void.
*
* Return(s)   : None.
*
* Note(s)     : None.
