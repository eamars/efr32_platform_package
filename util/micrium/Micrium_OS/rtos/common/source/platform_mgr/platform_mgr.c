...
*
* Description : Configure the quantities that are/can be allocated by the platform manager.
*
* Argument(s) : p_cfg   Pointer to the structure containing the platform manager quantity configuration.
*
* Return(s)   : None.
*
...
*
* Description : Add item to the platform manager.
*
* Argument(s) : p_item  Pointer to the item to add.
*
* Return(s)   : None
*
* Note(s)     : (1) This function does not return an error and instead asserts if adding the item failed.
...
*
* Description : Get item with the specified 'id_str' from the platform manager.
*
* Argument(s) : id_str  String with the ID of the item to get.
*
...
*                           RTOS_ERR_NOT_FOUND
*
* Return(s)   : Pointer to item, if found.
*               DEF_NULL, otherwise.
*
* Note(s)     : None.
*********************************************************************************************************
...
*                                           PlatformMgrInit()
*
* Description : Initialize the platform manager sub-module.
*
...
*
* Description : Allocate platform manager item.
*
* Argument(s) : item_size   Size of the item to allocate.
*
...
*                               RTOS_ERR_SEG_OVF
*
* Return(s)   : Allocated platform manager item, if NO error(s),
*               DEF_NULL, otherwise.
*
* Note(s)     : None.
*********************************************************************************************************
...
*                                         PlatformMgrItemGet()
*
* Description : Get item identified by predicate function passed.
*
* Argument(s) : predicate_fnct      Function that will be called for each item to know if it is the item
*                                   that needs to be removed.
*
*               p_predicate_data    Pointer to argument that will be passed to predicate.
*
...
*               DEF_NULL, otherwise.
*
* Note(s)     : (1) No call to the platform mgr should be done from the predicate, as the lock is
...
*                                         PlatformMgrItemRem()
*
* Description : Remove specified item from the platform manager.
*
* Argument(s) : p_item  Pointer to the item to remove.
*
*               p_err   Pointer to the variable that will receive one of the following error code(s) from
*                       this function:
*
...
*
* Description : Finds and returns list adapter identified by the predicate.
*
* Argument(s) : predicate_fnct      Function that will be called for each item to know if it is the item
*                                   for which the list adapter needs to be returned.
*
*               p_predicate_data    Pointer to argument passed to predicate.
*
*               p_err               Pointer to the variable that will receive one of the following error
*                                   code(s) from this function:
*
...
*                                       RTOS_ERR_NOT_FOUND
*
* Return(s)   : Pointer to list adapter, if found.
*               DEF_NULL, otherwise.
*
* Note(s)     : (1) The platform mgr lock must be acquired when calling this function.
*********************************************************************************************************
*/
...
*
* Description : Predicate function to obtain a platform manager item based on its string ID.
*
* Argument(s) : p_item              Pointer to item that needs to be evaluated.
*
*               p_predicate_data    Pointer to predicate data argument provided by caller, in this case,
*                                   the string ID of the item to match.
*
* Return(s)   : DEF_YES, if the item is the one that should be used,
*               DEF_NO, otherwise.
*
* Note(s)     : None.
*********************************************************************************************************
...
*
* Description : Predicate function to obtain a platform manager item based on its item pointer.
*
* Argument(s) : p_item              Pointer to item that needs to be evaluated.
*
*               p_predicate_data    Pointer to predicate data argument provided by caller, in this case,
