...
*
* Description : Configure the properties of the root user, in the Auth sub-module.
*
* Argument(s) : p_cfg   Pointer to the structure containing the new root user parameters.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is optional. If it is called, it must be called before Auth_Init(). If
...
*
* Description : Configure the properties of the resources used by the Auth sub-module.
*
* Argument(s) : p_cfg   Pointer to the structure containing the new resource usage parameters.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is optional. If it is called, it must be called before Auth_Init(). If
...
*
* Description : Configure the memory segment that will be used to allocate internal data needed by Auth
...
*                                              Auth_Init()
*
* Description : Initializes authentication module.
*
...
* Return(s)   : None.
*
* Note(s)     : (1) The functions Auth_Configure...() can be used to configure more specific properties
...
*                                         Auth_CreateUser()
*
* Description : Creates a user profile and fills the properties of the user profile structure provided.
*
* Argument(s) : p_name  Pointer to the user name string.
*
*               p_pwd   Pointer to the password string.
*
...
*                           RTOS_ERR_TIMEOUT
*
* Return(s)   : Handle of the created user profile.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*
*               p_as_user   Pointer to the user profile with the permission level to perform the action.
...
*                                            Auth_GetUser()
*
* Description : Gets the specific user profile structure according to the name provided.
*
* Argument(s) : p_name  Pointer to the user name string to retrieve.
*
*               p_err   Pointer to the variable that will receive one of the following error code(s) from
*                       this function:
*
...
*                           RTOS_ERR_TIMEOUT
*
* Return(s)   : Handle of the user associated with the name provided.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*                                          Auth_GetUserRight()
*
* Description : Gets the rights of the user associated with the specified user handle.
*
* Argument(s) : user_handle     User handle of the user profile from which to retrieve the rights.
*
...
*                                   RTOS_ERR_TIMEOUT
*
* Return(s)   : User's rights,   if no errors.
...
*                           RTOS_ERR_TIMEOUT
*
* Return(s)   : Handle of the user associated with the provided name and password, if no errors.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*                                           Auth_GrantRight()
*
* Description : Grants a specific right to a user as another user (limits the rights granted).
*
* Argument(s) : right           The new right to grant.
*
*               user_handle     User handle of the user that will receive the new right.
*
*               as_user_handle  User handle of the user with the permission level to perform this task.
*
*               p_err           Pointer to the variable that will receive one of the following error
*                               code(s) from this function:
*
...
*                                          Auth_RevokeRight()
*
* Description : Revokes a specific right of a specified user.
*
* Argument(s) : right           Right to revoke.
*
*               user_handle     User handle of the user that will have right revoked.
*
*               as_user_handle  User handle of the user with the permission level to perform this task.
*
*               p_err           Pointer to the variable that will receive one of the following error
...
*                                         Auth_GetUserHandler()
*
* Description : Gets the user structure with the given name.
*
* Argument(s) : p_name  Pointer to the user name string to retrieve.
*
*               p_err   Pointer to the variable that will receive one of the following error code(s) from
...
*                           RTOS_ERR_NOT_FOUND
*
* Return(s)   : Pointer to the user object, if no errors.
*               DEF_NULL, otherwise.
*
* Note(s)     : (1) This function must only be called while the authentication lock is acquired.
*********************************************************************************************************
*/
