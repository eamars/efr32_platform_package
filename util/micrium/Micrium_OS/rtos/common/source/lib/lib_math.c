...
*                                          Math_RandSetSeed()
*
* Description : Sets the current pseudo-random number generator seed.
*
...
*                                              Math_Rand()
*
* Description : Calculates the next pseudo-random number.
*
* Argument(s) : None.
*
...
*
*                   (b) However, to implement Math_Rand() as re-entrant; 'Math_RandSeedCur' MUST
...
*                   (b) The pseudo-random number generated is in the range [0, RAND_LCG_PARAM_M].
*
                    See 'lib_math.h  RANDOM NUMBER DEFINES  Note #1b'.
*
*               (2) (a) IEEE Std 1003.1, 2004 Edition, Section 'rand() : DESCRIPTION' states that "rand()
*                       ... need not be reentrant ... [and] is not required to be thread-safe".
*
...
*                                              Math_Init()
*
* Description : Initializes the Mathematic Module.
*
* Argument(s) : None.
*
* Return(s)   : None.
*
* Note(s)     : (1) IEEE Std 1003.1, 2004 Edition, Section 'rand() : DESCRIPTION' states that "if rand()
*                   is called before any calls to srand() are made, the same sequence shall be generated
*                   as when srand() is first called with a seed value of 1".
*
*               (2) The following function is deprecated. Unless already used, it should no longer be
