...
*
* Description : Returns logging argument corresponding to the given error code. The logging argument is
*               either a string or an integer depending on whether the error strings are enabled or not.
*
* Argument(s) : err_code    Error code to generate logging argument from.
*
* Return(s)   : Log argument for error code.
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*
* Description : Returns logging argument corresponding to the given error (extended or not depending on
...
*
* Argument(s) : err_var    Error (of type RTOS_ERR) to generate logging argument from.
*
* Return(s)   : Log argument for error variable.
*
* Note(s)     : none.
*********************************************************************************************************
*/
...
*
* Description : Sets a given error variable to an error value. Also sets the extended error content, if
...
*
*               err_code    Error code to which to set 'err_var' / *p_err.
*
*               __VA_ARGS__ Variable arguments that will be passed to the logging function. See LOG_ERR()
*                           for more details.
*
* Return(s)   : none.
*
...
*
* Description : Validate an error pointer received, to see if it can be used to report an error.
*
* Argument(s) : p_err       Error pointer to validate.
*
*               ret_val     Value that would be returned from the function, ';' if void.
*
* Return(s)   : none.
*
* Note(s)     : (1) Since no error can be reported if the error pointer is NULL, a CPU_SW_EXCEPTION is
*                   ALWAYS executed if this assert fails. See ASSERT DEFINES's Note #2.
*
*               (2) Usage of RTOS_ASSERT_DBG_ERR_PTR_VALIDATE is as follows:
...
*
* Description : Assert given expression. In case of failure, log, set error and call
...
* Return(s)   : none.
*
* Note(s)     : (1) Usage of RTOS_ASSERT_CRITICAL_ERR_SET / RTOS_ASSERT_DBG_ERR_SET /
