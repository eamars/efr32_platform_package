...
#include  <rtos/common/source/clk/clk_cmd_priv.h>
...
*
* Description : Configure the clock task stack properties to use the parameters contained in the passed
*               structure instead of the default parameters.
*
* Argument(s) : stk_size_elements   Size of the stack, in CPU_STK elements.
*
*               p_stk_base          Pointer to base of the stack.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is optional. If it is called, it must be called before Clk_Init(). If
...
*                                         Clk_ConfigureMemSeg()
*
* Description : Configure the memory segment that will be used to allocate internal data needed by Clock
...
*                                              Clk_Init()
*
* Description : Initializes the Clock module as follows :
*
...
* Return(s)   : None.
*
* Note(s)     : (1) The functions Clk_Configure...() can be used to configure more specific properties of
...
*                                           Clk_TaskPrioSet()
*
* Description : Sets the priority of the internal clock task.
*
* Argument(s) : prio    New priority at which to set the clock task.
*
...
* Return(s)   : None.
*
* Note(s)     : (1) This function must be called after Clk_Init().
*********************************************************************************************************
*/
...
*                                            Clk_SignalClk()
*
* Description : Increments the clock tick counter as follows :
*
...
*                                              Clk_GetTS()
*
* Description : Gets the current Clock timestamp.
*
* Argument(s) : None.
*
* Return(s)   : Current timestamp (in seconds, UTC+00).
*
* Note(s)     : (1) Internal Clock timestamp ('Clk_TS_UTC_sec') should be set to UTC+00. When calling
...
*                                              Clk_SetTS()
*
* Description : Sets the Clock timestamp.
*
* Argument(s) : ts_sec  Current timestamp to set (in seconds, UTC+00).
*
* Return(s)   : DEF_OK, if the timestamp is successfully set.
*
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) Internal Clock timestamp ('Clk_TS_UTC_sec') should be set to UTC+00 and should
...
*                                              Clk_GetTZ()
*
* Description : Gets the Clock time zone offset.
*
* Argument(s) : None.
*
* Return(s)   : Time zone offset (in seconds, +|- from UTC).
*
* Note(s)     : (1) Time zone is based on Coordinated Universal Time (UTC) and uses the following values :
*
...
*                                              Clk_SetTZ()
*
* Description : Sets the Clock time zone offset.
*
* Argument(s) : tz_sec  Time zone offset (in seconds, +|- from UTC).
*
* Return(s)   : DEF_OK, if the time zone is valid and set.
*
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) Time zone is based on Coordinated Universal Time (UTC) and uses the following values :
...
*                                           Clk_GetDateTime()
*
* Description : Gets the current Clock timestamp as a date/time structure.
*
* Argument(s) : p_date_time     Pointer to the variable that will receive the date/time structure.
*
* Return(s)   : DEF_OK, if the timestamp is valid & date/time structure successfully returned.
*
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) Internal Clock time zone offset ('Clk_TZ_sec') calculates the returned local
...
*                                           Clk_SetDateTime()
*
* Description : Sets the Clock timestamp using a date/time structure.
*
* Argument(s) : p_date_time     Pointer to the variable that contains the date/time structure.
*
* Return(s)   : DEF_OK, if the Clock date/time is successfully set.
*
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) (a) Date/time ('p_date_time') should be set to local time with the correct time zone
...
*
*                   (c) Time zone is based on Coordinated Universal Time (UTC) and uses the following values :
*
...
*                                          Clk_TS_ToDateTime()
*
* Description : Converts the Clock timestamp to a date/time structure.
*
* Argument(s) : ts_sec          Timestamp to convert (in seconds,          UTC+00).
*
*               tz_sec          Time zone offset     (in seconds, +|- from UTC).
*
*               p_date_time     Pointer to the variable that receives the date/time structure.
*
...
*                                          Clk_DateTimeToTS()
*
* Description : Converts the date/time structure to the Clock timestamp.
*
* Argument(s) : p_ts_sec        Pointer to the variable that receives the Clock timestamp :
*
*                                   In seconds UTC+00, if NO error(s);
*                                   CLK_TS_SEC_NONE, otherwise.
*
*               p_date_time     Pointer to the variable that contains date/time structure to convert.
*
* Return(s)   : DEF_OK, if the timestamp has successfully returned.
*
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) Date/time structure ('p_date_time') MUST be representable in the Clock timestamp,
...
*
*                   (b) Time zone is based on Coordinated Universal Time (UTC) and uses the following values :
*
*                       (1) Between  +|- 12 hours (+|- 43200 seconds)
*                       (2) Multiples of a 15 minute interval
*
*               (3) In case of errors, pointers to variables that return values MUST be initialized
...
*                                          Clk_DateTimeMake()
*
* Description : Builds a valid Clock epoch date/time structure.
*
* Argument(s) : p_date_time     Pointer to the variable that will receive the date/time structure.
*
...
*                   (b) <  CLK_EPOCH_YR_END
*
*               (2) If the date is valid, the Day of week ('p_date_time->DayOfWk') and Day of year
*                   ('p_date_time->DayOfYr') are internally calculated and set in the date/time structure.
*
*               (3) A Seconds value of 60 is valid to ensure compatiblity with leap second adjustment and
*                   the atomic clock time structure.
*
*               (4) Time zone is based ('tz_sec') on Coordinated Universal Time (UTC) and uses the
*                   following values :
*
*                   (a) Between  +|- 12 hours (+|- 43200 seconds)
*                   (b) Multiples of a 15 minute interval
...
*                                         Clk_IsDateTimeValid()
*
* Description : Determines if the date/time structure is valid in the Clock epoch.
*
* Argument(s) : p_date_time     Pointer to the variable that contains the date/time structure to validate.
*
* Return(s)   : DEF_YES, if date/time structure is valid.
*
*               DEF_NO, otherwise.
*
* Note(s)     : (1) Date/time structure ('p_date_time') MUST be representable in Clock epoch, so
...
*
* Note(s)     : (1) It's only possible to get a day of week of an epoch supported by the Clock :
*
...
*                                           Clk_GetDayOfYr()
*
* Description : Gets the day of year.
*
* Argument(s) : yr      Year  value [1900 to 2135] (see Note #1).
*
*               month   Month value [   1 to   12] / [CLK_MONTH_JAN to CLK_MONTH_DEC].
...
*
* Argument(s) : p_date_time     Pointer to the variable that contains the date/time structure to convert.
*
...
*
*               p_str           Pointer to the buffer that will receive the formated string (see Note #2).
*
*               str_len         Maximum number of characters the string can contains.
*
* Return(s)   : DEF_OK, if the string successfully returned.
*
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) It is only possible to convert date supported by the Clock :
*
*                   (a) Earliest year is the NTP epoch start year, so the Year ('yr') MUST be greater
*                       than or equal to 'CLK_NTP_EPOCH_YR_START'.
*
...
*
*               (3) Pointers to variables that return values MUST be initialized before all other
...
*                                            Clk_GetTS_NTP()
*
* Description : Gets the current Clock timestamp as an NTP timestamp.
*
* Argument(s) : p_ts_ntp_sec    Pointer to the variable that will receive the NTP timestamp :
*
*                                   In seconds UTC+00,  if NO error(s);
*                                   CLK_TS_SEC_NONE,    otherwise.
*
* Return(s)   : DEF_OK, if the timestamp successfully returned.
*
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) (a) NTP timestamp is converted from the internal Clock timestamp (should
*                       be set at UTC+00), so the NTP timestamp is returned at UTC+00.
*
*                   (b) NTP timestamp does NOT include the internal Clock time zone, so any
*                       local time zone offset MUST be applied after calling Clk_GetTS_NTP().
*
*               (2) NTP timestamp will eventually overflow, so it is not possible to get an NTP
...
*                                            Clk_SetTS_NTP()
*
* Description : Sets the Clock timestamp from an NTP timestamp.
*
* Argument(s) : ts_ntp_sec  Current NTP timestamp to set (in seconds, UTC+00).
*
* Return(s)   : DEF_OK, if the timestamp successfully set.
*
*               DEF_FAIL, otherwise.
*
...
*                   time zone offset.
*
*               (2) Only years supported by Clock & NTP can be set, so the timestamp date MUST be :
*
*                   (a) >= CLK_EPOCH_YR_START
...
*                                           Clk_TS_ToTS_NTP()
*
* Description : Converts the Clock timestamp to an NTP timestamp.
*
* Argument(s) : ts_sec          Timestamp to convert (in seconds, UTC+00).
*
*               p_ts_ntp_sec    Pointer to the variable that will receive the NTP timestamp :
*
*                                   In seconds UTC+00,  if NO error(s);
*                                   CLK_TS_SEC_NONE, otherwise.
*
* Return(s)   : DEF_OK, if the timestamp successfully converted.
*
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) Returned timestamp does NOT include any time zone offset, so any local time
*                   zone offset should be applied before or after calling Clk_TS_ToTS_NTP().
*
*               (2) Only years supported by Clock & NTP can be converted, so the timestamp date
*                   MUST be :
*
*                   (a) >= CLK_EPOCH_YR_START
*                   (b) <  CLK_NTP_EPOCH_YR_END
...
*                                           Clk_TS_NTP_ToTS()
*
* Description : Converts the NTP timestamp to the Clock timestamp.
*
* Argument(s) : p_ts_sec        Pointer to the variable that will receive the Clock timestamp :
*
*                                   In seconds UTC+00,  if NO error(s);
*                                   CLK_TS_SEC_NONE, otherwise.
*
...
*
* Return(s)   : DEF_OK, if the timestamp is successfully converted.
*
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) Returned timestamp does NOT include any time zone offset, so any local time zone
*                   offset should be applied before or after calling Clk_TS_NTP_ToTS().
*
*               (2) Only years supported by Clock & NTP can be converted, so the timestamp date MUST be :
*
*                   (a) >= CLK_EPOCH_YR_START
*                   (b) <  CLK_NTP_EPOCH_YR_END
*
...
*
* Description : Converts NTP timestamp to date/time structure.
*
* Argument(s) : ts_ntp_sec      Timestamp to convert (in seconds,          UTC+00).
*
*               tz_sec          Time zone offset     (in seconds, +|- from UTC).
*
*               p_date_time     Pointer to the variable that will receive the date/time structure.
*
* Return(s)   : DEF_OK, if date/time structure is successfully returned.
*
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) (a) Timestamp ('ts_ntp_sec') MUST be set for UTC+00 and should NOT include the time
...
*
* Description : Converts a date/time structure to an NTP timestamp.
*
* Argument(s) : p_ts_ntp_sec    Pointer to the variable that will receive the NTP timestamp :
*
*                                   In seconds UTC+00, if NO error(s);
*                                   CLK_TS_SEC_NONE, otherwise.
*
*               p_date_time     Pointer to the variable that contains the date/time structure to convert.
*
* Return(s)   : DEF_OK, if the timestamp successfully returned.
*
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) Date/time structure ('p_date_time') MUST be representable in the NTP timestamp, so
...
*
* Description : Builds a valid NTP epoch date/time structure.
*
* Argument(s) : p_date_time     Pointer to the variable that will receive the date/time structure.
*
...
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) Date/time structure ('p_date_time') MUST be representable in the NTP timestamp,
*                   so the date to convert MUST be :
*
*                   (a) >= CLK_NTP_EPOCH_YR_START
*                   (b) <  CLK_NTP_EPOCH_YR_END
...
*
*               (3) The Seconds value of 60 is valid to be compatible with the leap second adjustment and
*                   the atomic clock time structure.
*
*               (4) Time zone is based ('tz_sec') on Coordinated Universal Time (UTC)and uses the following
*                   values :
*
*                   (a) Between  +|- 12 hours (+|- 43200 seconds)
*                   (b) Multiples of a 15 minute interval
...
*
* Description : Determines if the date/time structure is valid in the NTP epoch.
*
* Argument(s) : p_date_time     Pointer to the variable that contains the date/time structure to validate.
*
* Return(s)   : DEF_YES, if the date/time structure is valid.
*
*               DEF_NO, otherwise.
*
* Note(s)     : (1) Date/time structure ('p_date_time') MUST be representable in NTP epoch,so the
...
*                                           Clk_GetTS_Unix()
*
* Description : Gets current Clock timestamp as a Unix timestamp.
*
* Argument(s) : p_ts_unix_sec   Pointer to the variable that will receive the Unix timestamp :
*
*                                   In seconds UTC+00,  if NO error(s);
*                                   CLK_TS_SEC_NONE,    otherwise.
*
* Return(s)   : DEF_OK, if the timestamp is successfully returned.
*
*               DEF_FAIL, otherwise.
*
* Note(s)     : (1) (a) Unix timestamp is converted from the internal Clock timestamp which should be set
*                       for UTC+00, so the Unix timestamp is returned at UTC+00.
*
*                   (b) Unix timestamp does NOT include the internal Clock time zone, so any local time
*                       zone offset MUST be applied after calling Clk_GetTS_Unix().
*
*               (2) Unix timestamp will eventually overflow, so it is not possible to get Unix timestamp
...
*                                           Clk_SetTS_Unix()
*
* Description : Sets the Clock timestamp from a Unix timestamp.
*
...
*                   time zone offset.
*
*               (2) Only years supported by Clock & Unix can be set, so the timestamp date MUST be :
*
*                   (a) >= CLK_EPOCH_YR_START
...
*                                         Clk_TS_ToTS_Unix()
*
* Description : Converts the Clock timestamp to a Unix timestamp.
*
* Argument(s) : ts_sec          Timestamp to convert (in seconds, UTC+00).
*
*               p_ts_unix_sec   Pointer to the variable that will receive the Unix timestamp :
*
*                                   In seconds UTC+00, if NO error(s);
*                                   CLK_TS_SEC_NONE, otherwise.
*
...
*
*               (2) Only years supported by the Clock & Unix can be converted, so the timestamp date must
*                   be :
*
*                   (a) >= CLK_EPOCH_YR_START
*                   (b) <  CLK_UNIX_EPOCH_YR_END
...
*                                          Clk_TS_UnixToTS()
*
* Description : Converts Unix timestamp to Clock timestamp.
*
* Argument(s) : p_ts_sec        Pointer to the variable that will receive the Clock timestamp :
*
*                                   In seconds UTC+00, if NO error(s);
...
*
*               (2) Only years supported by Clock & Unix can be converted, so the timestamp date must be:
*
*                   (a) >= CLK_EPOCH_YR_START
*                   (b) <  CLK_UNIX_EPOCH_YR_END
*
...
*
* Description : Converts the Unix timestamp to a date/time structure.
*
...
*               p_date_time     Pointer to the variable that will receive the date/time structure.
*
* Return(s)   : DEF_OK, if the date/time structure successfully returned.
*
*               DEF_FAIL, otherwise.
*
...
*
* Description : Converts a date/time structure to a Unix timestamp.
*
* Argument(s) : p_ts_sec        Pointer to the variable that will receive the Unix timestamp :
*
*                                   In seconds UTC+00,  if NO error(s);
*                                   CLK_TS_SEC_NONE,    otherwise.
*
...
*
* Description : Builds a valid Unix epoch date/time structure.
*
* Argument(s) : p_date_time     Pointer to the variable that will receive the date/time structure.
*
...
*                   the atomic clock time structure.
*
*               (4) Time zone is based ('tz_sec') on Coordinated Universal Time (UTC) and has valid
*                   values :
*
*                   (a) Between  +|- 12 hours (+|- 43200 seconds)
*                   (b) Multiples of a 15 minute interval
...
*               DEF_NO, otherwise.
*
* Note(s)     : (1) Date/time structure ('p_date_time') MUST be representable in Unix epoch, so the
*                   date to validate MUST be :
*
*                   (a) >= CLK_UNIX_EPOCH_YR_START
*                   (b) <  CLK_UNIX_EPOCH_YR_END
...
*                                           Clk_IsDateValid()
*
* Description : Determines if the date values are valid.
*
...
*                                         Clk_IsDayOfYrValid()
*
* Description : Determines if the day of year is valid.
*
* Argument(s) : yr          Year        value [1900 to 2135].
*
...
*                                         Clk_IsDayOfWkValid()
*
* Description : Determines if the day of week is valid.
*
...
*                                           Clk_IsTimeValid()
*
* Description : Determines if time values are valid.
*
...
*               DEF_NO, otherwise.
*
* Note(s)     : (1) The Seconds value of 60 is valid to be compatible with leap second adjustment and
*                   the atomic clock time structure.
*********************************************************************************************************
*/
...
*                                            Clk_IsTZValid()
*
* Description : Determines if the time zone is valid.
*
...
*               DEF_NO, otherwise.
*
* Note(s)     : (1) Time zone is based ('tz_sec') on Coordinated Universal Time (UTC) and uses the following values :
*
*                   (a) Between  +|- 12 hours (+|- 43200 seconds)
*                   (b) Multiples of a 15 minute interval
*
...
*
* Description : Determines if date/time structure is valid.
*
* Argument(s) : p_date_time     Pointer to the variable that contains the date/time structure to validate.
*
*               yr_start        Start year of the epoch.
...
*                                      Clk_TS_ToDateTimeHandler()
*
* Description : Converts any type of timestamp to date/time structure.
*
* Argument(s) : ts_sec          Timestamp to convert (in seconds,          UTC+00).
*
*               tz_sec          Time zone offset     (in seconds, +|- from UTC).
*
*               p_date_time     Pointer to the variable that contains the date/time structure to validate.
*
*               yr_start        Start year of the epoch.
*
*               yr_end          End year of the epoch.
...
*
*                       (1) For negative timezone offset, the amount is subtracted
*                       (2) For positive timezone offset, the amount is added
*
...
*
* Description : Converts the date/time structure to any type of timestamp.
*
* Argument(s) : p_ts_sec        Pointer to the variable that will receive the timestamp :
*               --------
*                                   In seconds UTC+00, if NO error(s);
*                                   CLK_TS_SEC_NONE, otherwise.
*
...
*               yr_start        Start year of the epoch.
*
* Return(s)   : DEF_OK, if the timestamp is valid.
*
*               DEF_FAIL, otherwise.
*
...
*
*               (2) In case of errors, pointers to variables that return values MUST be initialized
*                   before all other validation or function handling.
*
...
*                                       Clk_DateTimeMakeHandler()
*
* Description : Builds a valid epoch date/time structure.
*
* Argument(s) : p_date_time     Pointer to the variable that will receive the date/time structure.
*
...
*                   are internally calculated and set in the date/time structure if date is valid.
*
*               (2) The Seconds value of 60 is valid to be compatible with leap second adjustment and
*                   the atomic clock time structure.
*
*               (3) Time zone is based ('tz_sec') on Coordinated Universal Time (UTC) and has valid
*                   values :
*
*                   (a) Between  +|- 12 hours (+|- 43200 seconds)
*                   (b) Multiples of 15 minute intervals
...
*                                           Clk_TaskHandler()
*
* Description : Handles clock signal : waits for a signal and updates the timestamp.
*
* Argument(s) : p_arg   Pointer to argument (unused).
*
* Return(s)   : None.
*
* Note(s)     : 'Clk_TS_UTC_sec' MUST ALWAYS be accessed exclusively in critical sections.
*********************************************************************************************************
*/
