...
*                                             ClkCmd_Init()
*
* Description : Adds the Clk commands to Shell.
*
...
*               p_argv      Array of pointers to the strings which are those arguments.
*
*               p_cmd_args  Pointer to structure that will be filled during parse operation.
*
* Return(s)   : Clock command parse status:
*                               CLK_CMD_PARSE_STATUS_SUCCESS
*                               CLK_CMD_PARSE_STATUS_EMPTY
*                               CLK_CMD_PARSE_STATUS_INVALID_ARG
*                               CLK_CMD_PARSE_STATUS_HELP
