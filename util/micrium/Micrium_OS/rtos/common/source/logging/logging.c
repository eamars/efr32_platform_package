...
*                                           Log_DataIsAvail()
*
* Description : Indicates if there is data present to be logged or not.
*
* Argument(s) : None.
*
* Return(s)   : DEF_YES,  if there is data that is available to be logged,
*               DEF_FAIL, otherwise.
*
* Note(s)     : None.
*********************************************************************************************************
...
*                                             Log_Output()
*
* Description : Outputs data accumulated in the ring buffer.
*
* Argument(s) : None.
*
* Return(s)   : None.
...
*                                              Log_Init()
*
* Description : Initializes the logging module.
*
* Argument(s) : p_cfg   Pointer to the logging configuration structure. If AsyncBufSize is 0, the
...
*                                         Logging_OutputFunc()
*
* Description : Output function used to print data by the logging module.
*
* Argument(s) : c       Character to output.
*
*               p_arg   Callback function that needs to be used to output character.
*
* Return(s)   : 0.
*
* Note(s)     : none.
...
*
* Description : Gets correct type specifier based on 'spec' and 'len' to pass to printf-like functions.
*
* Argument(s) : p_type_spec     Pointer to start of type specifier buffer.
*
