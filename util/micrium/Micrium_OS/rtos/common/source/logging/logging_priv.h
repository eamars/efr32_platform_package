...
#include  <rtos/common/source/preprocessor/preprocessor_priv.h>
...
#define _LOG_CHAR_HEX_ESC(arg)                                       PP_CONCAT(\x, arg)
...
#include  <rtos/common/source/logging/logging_chk_priv.h>
