...
*                                         Serial_CtrlrDrvInit()
*
* Description : Initializes serial bus driver.
*
* Argument(s) : p_ser_drv   Pointer to serial bus driver structure.
*
*               handle      Handle to serial controller.
*
*               p_mem_seg   Pointer to memory segment to use for data allocation.
*
...
* Argument(s) : p_ser_drv   Pointer to serial bus driver structure.
*
*               mode        Mode in which the serial controller should be started.
*
...
*                                        Serial_CtrlrDrvCfgChk()
*
* Description : Validates configuration (ensures desired configurations are supported by
*               driver/controller).
*
* Argument(s) : p_ser_drv       Pointer to serial bus driver structure.
*
*               p_serial_cfg    Pointer to serial configuration structure.
*
...
*                                   RTOS_ERR_NONE
*
* Return(s)   : Boolean indicating if configurations are supported or not.
*
*                   DEF_VALID
*                   DEF_INVALID
*
* Note(s)     : (1) No esay way to validate the configurations. Let's assume they are valid.
*********************************************************************************************************
*/
...
*                                         Serial_CtrlrDrvCfg()
*
* Description : Configure serial controller.
*
* Argument(s) : p_ser_drv       Pointer to serial bus driver structure.
*
*               p_serial_cfg    Pointer to serial configuration structure.
...
*                                       Serial_CtrlrDrvSlaveSel()
*
* Description : Selects given slave.
*
* Argument(s) : p_ser_drv       Pointer to serial bus driver structure.
*
...
*                                      Serial_CtrlrDrvSlaveDesel()
*
* Description : Deselects given slave.
*
* Argument(s) : p_ser_drv       Pointer to serial bus driver structure.
*
*               p_slave_info    Pointer to slave information structure.
...
*                                          Serial_CtrlrDrvRx()
*
* Description : Starts data reception on serial bus.
*
* Argument(s) : p_ser_drv   Pointer to serial bus driver structure.
*
*               p_buf       Pointer to receive buffer.
*
*               buf_len     Length of receive buffer, in octets.
*
*               p_err       Pointer to the variable that will receive one of the following error code(s)
*                           from this function:
*
...
*                                          Serial_CtrlrDrvTx()
*
* Description : Starts data transmission on serial bus.
*
* Argument(s) : p_ser_drv   Pointer to serial bus driver structure.
*
*               p_buf       Pointer to transmit buffer.
*
*               buf_len     Length of transmit buffer, in octets.
*
*               p_err       Pointer to the variable that will receive one of the following error code(s)
*                           from this function:
*
...
* Return(s)   : None.
*
* Note(s)     : (1) Enabling the transmit interrupt will trigger a tx buffer empty interrupt right away,
...
*                                          Serial_CtrlrDrvByteTx()
*
* Description : Transmit byte.
*
* Argument(s) : p_ser_drv   Pointer to serial bus driver structure.
*
*               byte        Byte to transmit.
*
*               len         Length of transmission (number of time the byte should be transmitted).
*
*               p_err       Pointer to the variable that will receive one of the following error code(s)
*                           from this function:
*
...
*                                        Serial_CtrlrDrvAbort()
*
* Description : Abort transmission/reception on serial bus.
*
* Argument(s) : p_ser_drv   Pointer to serial bus driver structure.
*
*               dir         Bitmap of direction(s) to abort.
*
*                               SERIAL_ABORT_DIR_RX
*                               SERIAL_ABORT_DIR_TX
*
...
* Return(s)   : None.
*
* Note(s)     : (1) RSPI controller is SPI only, so both directions are always aborted.
*********************************************************************************************************
*/
...
*                                       Serial_CtrlrDrvIO_Ctrl()
*
* Description : Perform IO Ctrl.
*
* Argument(s) : p_ser_drv   Pointer to serial bus driver structure.
*
*               cmd         Command to execute.
*
*               p_arg       Pointer to IOCtrl data. May be input, output, or DEF_NULL depending on the
*                           value of 'cmd'.
*
*               p_err       Pointer to the variable that will receive one of the following error code(s)
*                           from this function:
...
*                                     Serial_CtrlrDrvReqAlignGet()
*
* Description : Retrieves required data buffer alignment.
*
* Argument(s) : p_ser_drv   Pointer to serial bus driver structure.
*
* Return(s)   : Buffer alignment, in octets.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*                                       Serial_CtrlrDrvCallback()
*
* Description : Completes SPI transfer.
*
* Argument(s) : handle              SPIDRV handle.
*
*               transfer_status     Transfer status.
*
*               items_transferred   Length of data transferred.
*
* Return(s)   : None.
*
* Note(s)     : None.
