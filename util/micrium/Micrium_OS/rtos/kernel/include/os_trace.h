...
*
*               To support trace recording, include one of the sub-folders at the following location:
*               Micrium/Tools/TraceRecorders/ into your project.
*********************************************************************************************************
*********************************************************************************************************
*/
