...
*
*           (3) It has been tested with the following Hardware Floating Point Unit.
...
*                                           OSIdleTaskHook()
*
* Description : Allows you to stop the CPU (ex.: to conserve power). This function is called by the
*               idle task.
*
* Argument(s) : None.
*
...
*                                             OSInitHook()
*
* Description : Called by OSInit() at the beginning of OSInit().
*
* Argument(s) : None.
*
* Return(s)   : None.
*
* Note(s)     : (1) When using hardware floating point, follow these steps during the reset handler:
...
*                                          OSRedzoneHitHook()
*
* Description : Called when a task's stack has overflowed.
*
* Argument(s) : p_tcb   Pointer to the TCB of the offending task. NULL if ISR.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*                                           OSStatTaskHook()
*
* Description : This function is called every second by the Kernel's statistics task.  This allows your
...
*                                          OSTaskCreateHook()
*
* Description : Called when a task is created.
*
* Argument(s) : p_tcb   Pointer to the TCB of the task being created.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*                                            OSTaskDelHook()
*
* Description : Called when a task is deleted.
*
* Argument(s) : p_tcb   Pointer to the TCB of the task being deleted.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*                                          OSTaskReturnHook()
*
* Description : Called if a task accidentally returns. In other words, a task should either be an infinite
*               loop or delete itself when done.
*
* Argument(s) : p_tcb   Pointer to the TCB of the task that is returning.
*
* Return(s)   : None.
*
* Note(s)     : None.
...
*                                            OSTaskStkInit()
*
* Description : Initializes the stack frame of the task being created as if it had been already
...
*
*               p_stk_limit     Pointer to the element to set as the 'watermark' limit of the stack.
*
*               stk_size        Size of the stack (measured as number of CPU_STK elements).
*
*               opt             Options used to alter the behavior of OSTaskStkInit().
*                               See OS.H for OS_TASK_OPT_xxx.
*
* Return(s)   : Always returns the location of the new top-of-stack once the processor registers have
...
*                                            OSTaskSwHook()
*
* Description : Allows you to perform other operations during a context switch. This function is called
...
*                                           OSTimeTickHook()
*
* Description : Called upon every elapsed tick.
*
* Argument(s) : None.
*
* Return(s)   : None.
...
*
* Description : Handle the system tick (SysTick) interrupt, which is used to generate the the Kernel tick
*               interrupt.
*
* Argument(s) : None.
*
...
*
* Argument(s) : cnts    Number of SysTick counts between two OS tick interrupts.
*
* Return(s)   : None.
*
