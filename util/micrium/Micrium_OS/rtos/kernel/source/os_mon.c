...
*
* Argument(s) : p_mon       Pointer to the monitor to initialize. Your application is responsible for
*                           allocating storage space for the monitor.
*
*               p_name      Pointer to the name to assign to this monitor.
*
*               p_mon_data  Pointer to the monitor's global data.
*
...
*
* Argument(s) : p_mon   Pointer to the monitor to delete.
*
...
*
* Return(s)   : == 0    If there were no tasks waiting on the monitor, or upon error.
...
*
*               (2) Because ALL tasks pending on the monitor will be ready, be careful in applications
...
*                                               OSMonOp()
*
* Description : Performs an operation on a monitor.
*
* Argument(s) : p_mon       Pointer to the monitor.
*
*               timeout     Optional timeout to be applied if the monitor blocks (pending).
*
*               p_arg       Argument of the monitor.
*
*               p_on_enter  Callback called at the entry of OSMonOp().
*
...
*                                              OS_MonClr()
*
* Description : This function is called by OSMonDel() to clear the contents of the monitor.
*
* Argument(s) : p_mon   Pointer to the monitor to clear.
*
* Return(s)   : None.
*
...
*                                          OS_MonDbgListAdd()
*
* Description : Add a monitor to the monitor debug list.
*
* Argument(s) : p_mon   Pointer to the monitor to add.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
...
*                                         OS_MonDbgListRemove()
*
* Description : Remove a monitor from the monitor debug list.
*
* Argument(s) : p_mon   Pointer to the monitor to remove.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
