...
*                                              OSTimeDly()
*
* Description : Delays the execution of the currently running task until the specified number of system
...
*
* Argument(s) : dly     Value in 'clock ticks' that the task for which will either delay, the target
...
*                                            OSTimeDlyHMSM()
*
* Description : Delay execution of the currently running task until some time expires. This call allows
*               you to specify the delay time in HOURS, MINUTES, SECONDS, and MILLISECONDS instead of ticks.
*
*
* Argument(s) : hours       Specifies the number of hours that the task will be delayed (max. is 999 if the
...
*
*               opt         Specifies time delay bit-field options logically OR'd; default options marked
*                           with *** :
...
* Return(s)   : None.
*
* Note(s)     : (1) The resolution of milliseconds depends on the tick rate. For example, you cannot
...
*
*               (2) Although this function allows you to delay a task for many hours, it is not recommended
...
*                                           OSTimeDlyResume()
*
* Description : Resumes a task that has been delayed through a call to either OSTimeDly() or
...
*                                              OSTimeGet()
*
* Description : Used by your application to obtain the current value of the counter to keep track of
...
*                           RTOS_ERR_NONE
*
* Return(s)   : The current value of OSTickCtr.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*                                              OSTimeSet()
*
* Description : Sets the counter that keeps track of the number of clock ticks.
*
* Argument(s) : ticks   The desired tick value.
*
*               p_err   Pointer to the variable that will receive one of the following error code(s)
*                       from this function:
*
...
*                                             OSTimeTick()
*
* Description : Signal the Kernel an occurrence of a 'system tick' (also known as a 'clock tick').
...
*
* Argument(s) : ticks   Number of OS Ticks to process.
*
* Return(s)   : None.
*
* Note(s)     : None.
