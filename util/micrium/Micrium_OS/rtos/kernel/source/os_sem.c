...
*
* Argument(s) : p_sem   Pointer to the semaphore to initialize. Your application is responsible
*                       for allocating storage for the semaphore.
*
*               p_name  Pointer to the name to assign to the semaphore.
*
...
*
* Argument(s) : p_sem   Pointer to the semaphore to delete.
*
...
*
* Return(s)   : == 0    If there were no tasks waiting on the semaphore, or upon error.
...
*
*               (2) Because ALL tasks pending on the semaphore will be readied, be careful with
...
*
*               timeout     Optional timeout period (in clock ticks). If non-zero, your task will
...
*
*               p_ts        Pointer to a variable that receives the timestamp of when the semaphore was
...
*                               RTOS_ERR_TIMEOUT
*
* Return(s)   : The current value of the semaphore counter, or 0 if not available.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*                                           OSSemPendAbort()
*
* Description : Aborts and readies any tasks currently waiting on a semaphore. Rather than signal the
...
*
* Return(s)   : == 0    If no tasks were waiting on the semaphore, or upon error.
...
*                           RTOS_ERR_WOULD_OVF
*
* Return(s)   : The current value of the semaphore counter or 0 upon error.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*                                              OSSemSet()
*
* Description : Sets the semaphore count to the value specified as an argument. Typically
...
* Argument(s) : p_sem   Pointer to the semaphore.
*
*               cnt     The new value for the semaphore count. You would pass 0 to reset the semaphore
*                       count.
*
*               p_err   Pointer to the variable that will receive one of the following error code(s)
*                       from this function:
...
*
* Argument(s) : p_sem   Pointer to the semaphore to clear.
*
* Return(s)   : None.
*
...
*                                          OS_SemDbgListAdd()
*
* Description : Add a semaphore to the semaphore debug list.
*
* Argument(s) : p_sem   Pointer to the semaphore to add.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
...
*                                         OS_SemDbgListRemove()
*
* Description : Remove a semaphore from the semaphore debug list.
*
* Argument(s) : p_sem   Pointer to the semaphore to remove.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
