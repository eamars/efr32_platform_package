...
*                                             OS_TickTask()
*
* Description : This task is internal to the Kernel and is triggered by the tick interrupt.
*
...
*                                          OS_TickListInsert()
*
* Description : This function is called to insert a task in a tick list.
*
* Argument(s) : p_list  Pointer to the desired list.
*
*               p_tcb   Pointer to the TCB to insert in the list.
*
*               time    Amount of time remaining (in ticks) for the task to become ready.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
...
*
* Description : This function is called to place a task in a list of task waiting for either time to
*               expire.
*
* Argument(s) : p_tcb   Pointer to the TCB of the task to add to the tick list.
*
*               time    Represents either the 'match' value of OSTickCtr or a relative time from
...
*
*               opt     Option specifying how to calculate time. The valid values are:
*
...
*
* Return(s)   : Number of timestamp ticks elapsed in update, or 0 is timestamp is disabled.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
*********************************************************************************************************
*/
