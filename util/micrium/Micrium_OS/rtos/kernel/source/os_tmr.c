...
*                                             OSTmrCreate()
*
* Description : Called by your application code to create a timer.
*
* Argument(s) : p_tmr           Pointer to the timer to create. Your application is responsible
*                               for allocating storage for the timer.
*
*               p_name          Pointer to an ASCII string that names the timer (useful for debugging)
*
*               dly             Initial delay.
...
*
*               p_callback      Pointer to a callback function that will be called when the timer
*                               expires. The callback function must be declared as follows:
*
*                                   void  MyCallback (OS_TMR  *p_tmr, void  *p_arg);
*
*               p_callback_arg  Pointer to an argument that is passed to the callback function when it is
*                               called.
*
...
* Return(s)   : None.
*
* Note(s)     : (1) This function only creates the timer. In other words, the timer is not started when
...
*                                              OSTmrDel()
*
* Description : Called by your application code to delete a timer.
*
* Argument(s) : p_tmr   Pointer to the timer to stop and delete.
*
*               p_err   Pointer to the variable that will receive one of the following error code(s)
*                       from this function:
*
...
*                           RTOS_ERR_NOT_INIT
*
* Return(s)   : == DEF_TRUE     If the timer was deleted.
...
*                                           OSTmrRemainGet()
*
* Description : Called to get the number of ticks before a timer times out.
*
* Argument(s) : p_tmr   Pointer to the timer to obtain the remaining time from.
*
*               p_err   Pointer to the variable that will receive one of the following error code(s)
*                       from this function:
*
...
*                           RTOS_ERR_NOT_INIT
*
* Return(s)   : The time remaining for the timer to expire. The time represents 'timer' increments. In
...
*                                              OSTmrSet()
*
* Description : Called by your application code to set a timer.
*
* Argument(s) : p_tmr           Pointer to the timer to set.
*
*               dly             Initial delay.
*                               If the timer is configured for ONE-SHOT mode, this is the timeout used.
*                               If the timer is configured for PERIODIC mode, this is the first timeout
...
* Return(s)   : None.
*
* Note(s)     : (1) This function can be called on a running timer. The change to the delay and period
...
*                                             OSTmrStart()
*
* Description : Called by your application code to start a timer.
*
* Argument(s) : p_tmr   Pointer to the timer to start.
*
...
*                           RTOS_ERR_NOT_INIT
*
* Return(s)   : DEF_TRUE     If the timer was started.
*               DEF_FALSE    If the timer was not started or upon an error.
*
* Note(s)     : (1) When starting/restarting a timer, regardless if it is in PERIODIC or ONE-SHOT mode,
...
*                                            OSTmrStateGet()
*
* Description : Called to determine what state the timer is in:
*
...
*
* Argument(s) : p_tmr   Pointer to the timer.
*
*               p_err   Pointer to the variable that will receive one of the following error code(s)
*                       from this function:
*
*                           RTOS_ERR_NONE
*
* Return(s)   : The current state of the timer (see description).
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*                                              OSTmrStop()
*
* Description : Called by your application code to stop a timer.
*
* Argument(s) : p_tmr           Pointer to the timer to stop.
*
...
*
*               p_callback_arg  Pointer to a 'new' callback argument that can be passed to the
...
*
* Return(s)   : DEF_TRUE     If we stop the timer (if the timer is already stopped, it returns as
*                            DEF_TRUE).
...
*                                              OS_TmrClr()
*
* Description : Called to clear all timer fields.
*
* Argument(s) : p_tmr   Pointer to the timer to clear.
*
* Return(s)   : None.
*
...
*                                          OS_TmrDbgListAdd()
*
* Description : Add a timer to timer debug list.
*
* Argument(s) : p_tmr   Pointer to the timer to add.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
...
*                                         OS_TmrDbgListRemove()
*
* Description : Remove a timer to timer debug list.
*
* Argument(s) : p_tmr   Pointer to the timer to remove.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
...
*                                             OS_TmrInit()
*
* Description : Called by OSInit() to initialize the timer manager module.
*
...
*                                            OS_TmrUnlink()
*
* Description : Called to remove the timer from the timer list.
*
* Argument(s) : p_tmr   Pointer to the timer to remove.
*
* Return(s)   : None.
...
*
* Argument(s) : p_arg   Argument passed to the task when the task is created (unused).
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
...
*                                             OS_TmrLock()
*
* Description : This function is used to lock the timer processing code. The preferred method is to use
...
*                                            OS_TmrUnlock()
*
* Description : This function is used to unlock the timer processing code. The preferred method is to use
*               a mutex in order to avoid locking the scheduler and also, to avoid calling callback
*               functions while the scheduler is locked.
*
* Argument(s) : None.
