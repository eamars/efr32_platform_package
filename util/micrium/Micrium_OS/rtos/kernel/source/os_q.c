...
*                                              OSQCreate()
*
* Description : Called by your application to create a message queue. Message queues
*               MUST be created before they can be used.
*
* Argument(s) : p_q         Pointer to the message queue.
*
*               p_name      Pointer to an ASCII string used to name the message queue.
*
*               max_qty     Indicates the maximum size of the message queue (must be non-zero). Note
...
*
* Argument(s) : p_q     Pointer to the message queue to delete.
*
...
*
* Return(s)   : == 0    If no tasks were waiting on the queue, or upon error.
...
*                                              OSQFlush()
*
* Description : Flushes the contents of the message queue.
*
* Argument(s) : p_q     Pointer to the message queue to flush.
*
*               p_err   Pointer to the variable that will receive one of the following error
*                       code(s) from this function:
*
*                           RTOS_ERR_NONE
*
* Return(s)   : == 0    If no entries were freed, or upon error.
*               >  0    The number of freed entries.
*
* Note(s)     : (1) Use great care with this function because when you flush the queue, you
...
*                                               OSQPend()
*
* Description : Waits for a message to be sent to a queue.
*
* Argument(s) : p_q         Pointer to the message queue.
*
*               timeout     Optional timeout period (in clock ticks). If non-zero, your task waits for a
...
*
*               p_msg_size  Pointer to a variable that receives the size of the message.
*
*               p_ts        Pointer to a variable that receives the timestamp of when the message was
...
*                               RTOS_ERR_TIMEOUT
*
* Return(s)   : != (void *)0    Pointer to the message received.
...
*                                            OSQPendAbort()
*
* Description : Aborts and readies any tasks currently waiting on a queue. Use this function to
...
*                                               OSQPost()
*
* Description : Sends a message to a queue. With the 'opt' argument, you can specify
...
*
* Argument(s) : p_q         Pointer to a message queue.
*
...
*
* Argument(s) : p_q     Pointer to the queue to clear.
*
* Return(s)   : None.
*
...
*                                           OS_QDbgListAdd()
*
* Description : Add a message queue to the message queue debug list.
*
* Argument(s) : p_q     Pointer to the message queue to add.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
...
*                                          OS_QDbgListRemove()
*
* Description : Remove a message queue from the message queue debug list.
*
* Argument(s) : p_q     Pointer to the message queue to remove.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
