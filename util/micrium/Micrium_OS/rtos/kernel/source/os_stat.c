...
*                                             OSStatReset()
*
* Description : Called by your application to reset the statistics.
*
...
*
* Description : Establishes CPU usage by first determining how high a 32-bit counter would count to in
...
*                                             OS_StatTask()
*
* Description : This task is internal to the Kernel and is used to compute some statistics about the
...
*
*               (2) You can disable this task by setting the configuration #define OS_CFG_STAT_TASK_EN
*                   to 0.
*
*               (3) You MUST have at least a delay of 2/10 seconds to allow for the system to establish
*                   the maximum value for the idle counter.
*
*               (4) This function is INTERNAL to the Kernel and your application MUST NOT call it.
*********************************************************************************************************
*/
