...
*
* Argument(s) : p_grp   Pointer to the event flag group to create. Your application is responsible
...
*               group.
*
* Argument(s) : p_grp   Pointer to the event flag group.
*
...
*
* Return(s)   : == 0    If no tasks were waiting on the event flag group, or upon error.
*               >  0    If one or more tasks waiting on the event flag group are now ready and
*                       informed.
*
* Note(s)     : (1) Use this function with care. Tasks that would normally expect the presence of
...
*                                             OSFlagPend()
*
* Description : This function is called to wait for a combination of bits to be set in an event flag group.
*               Your application can wait for either ANY bit to be set or ALL bits to be set.
*
* Argument(s) : p_grp       Pointer to the event flag group.
*
*               flags       Bit pattern that indicates which bit(s) (i.e. flags) to wait for.
...
*
*               p_ts        Pointer to a variable that receives the timestamp of when the event flag
...
*                               RTOS_ERR_TIMEOUT
*
* Return(s)   : The flags in the event flag group that made the task ready or, 0 if a timeout or an error
*               occurred.
*
* Note(s)     : None.
*********************************************************************************************************
...
*                                           OSFlagPendAbort()
*
* Description : This function aborts & prepares any tasks currently waiting on an event flag group.
...
*
* Description : This function is called to obtain the flags that caused the task to be ready.
...
*                           RTOS_ERR_NONE
*
* Return(s)   : The flags that caused the task to be ready.
*
* Note(s)     : None.
*********************************************************************************************************
*/
...
*                                             OSFlagPost()
*
* Description : This function is called to set or clear some bits in an event flag group. The bits to set
*               or clear are specified by a 'bit mask'.
*
* Argument(s) : p_grp   Pointer to the event flag group.
*
*               flags   If 'opt' (see below) is OS_OPT_POST_FLAG_SET, each bit set in 'flags' will be
...
*                           RTOS_ERR_NONE
*
* Return(s)   : The new value of the event flags bits that are still set.
*
* Note(s)     : (1) The execution time of this function depends on the number of tasks waiting on the
*                   event flag group.
*********************************************************************************************************
*/
...
*                                            OS_FlagBlock()
*
* Description : This function is internal to the Kernel and is used to put a task to sleep until the
*               desired event flag bit(s) are set.
*
* Argument(s) : p_grp       Pointer to the event flag group.
*
*               flags       Bit pattern indicating which bit(s) (i.e. flags) you wish to check.
...
*
*               timeout     The desired amount of time that the task will wait for the event flag
*                           bit(s) to be set.
*
* Return(s)   : None.
*
...
*
* Argument(s) : p_grp   Pointer to the event flag group to clear.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
...
*                                          OS_FlagDbgListAdd()
*
* Description : Add an event flag group from the event flag debug list.
*
* Argument(s) : p_grp   Pointer to the event flag group to add.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
...
*
* Description : Remove an event flag group from the event flag debug list.
*
* Argument(s) : p_grp   Pointer to the event flag group to remove.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
...
*                                           OS_FlagTaskRdy()
*
* Description : This function is internal to the Kernel and is used to make a task ready-to-run because
*               the desired event flag bits have been set.
*
* Argument(s) : p_tcb       Pointer to the OS_TCB of the task to remove.
*
*               flags_rdy   Contains the bit pattern of the event flags that cause the task to become
*                           ready-to-run.
*
*               ts          Timestamp associated with the post.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
