...
*                                             OSMemCreate()
*
* Description : Creates a fixed-sized memory partition that will be managed by the Kernel.
*
* Argument(s) : p_mem       Pointer to a memory partition control block which is allocated in user
*                           memory space.
*
*               p_name      Pointer to an ASCII string to provide a name to the memory partition.
*
*               p_addr      The starting address of the memory partition.
*
*               n_blks      The number of memory blocks to create from the partition.
*
*               blk_size    The size (in bytes) of each block in the memory partition.
*
...
*                                              OSMemGet()
*
* Description : Gets a memory block from a partition.
*
* Argument(s) : p_mem   Pointer to the memory partition control block.
*
*               p_err   Pointer to the variable that will receive one of the following error code(s)
*                       from this function:
*
...
*                           RTOS_ERR_POOL_EMPTY
*
* Return(s)   : A pointer to a memory block if no error is detected.
...
* Argument(s) : p_mem   Pointer to the memory partition control block.
*
*               p_blk   Pointer to the memory block being released.
*
*               p_err   Pointer to the variable that will receive one of the following error code(s)
*                       from this function:
*
...
*                                             OS_MemInit()
*
* Description : This function is called by the Kernel initialize the memory partition manager. Your
