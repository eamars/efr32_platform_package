...
void  OS_MsgPoolInit (RTOS_ERR  *p_err)
{
    ...
    OS_MSG_QTY   loops;
                                                                ...
                                                                /* Validate msg pool cfg                                */
    OS_ASSERT_DBG_ERR_SET((OSCfg_MsgPoolBasePtr != DEF_NULL), *p_err, RTOS_ERR_INVALID_CFG, ;);

    OS_ASSERT_DBG_ERR_SET((OSCfg_MsgPoolSize > 0u), *p_err, RTOS_ERR_INVALID_CFG, ;);
...
*
* Argument(s) : p_msg_q     Pointer to the OS_MSG_Q structure containing messages to free.
*
* Return(s)   : The number of OS_MSGs returned to the free list.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
*********************************************************************************************************
*/
...
*
* Argument(s) : p_msg_q     Pointer to the message queue to initialize.
*
*               max         The maximum number of entries that the message queue can have.
*
* Return(s)   : None.
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
...
*
* Argument(s) : p_msg_q     Pointer to the message queue where we want to extract the message from.
*
*               p_msg_size  Pointer to where the size (in bytes) of the message will be placed.
*
*               p_ts        Pointer to where the timestamp will be placed.
*
...
*                               RTOS_ERR_NOT_FOUND
*
* Return(s)   : The message (a pointer).
*
* Note(s)     : (1) This function is INTERNAL to the Kernel and your application MUST NOT call it.
*********************************************************************************************************
*/
...
*
* Argument(s) : p_msg_q     Pointer to the OS_TCB of the task to post the message to.
*
...
*
*               ts          Timestamp as to when the message was posted.
*
*               p_err       Pointer to variable that will receive the return error code from this function :
*
*                               RTOS_ERR_NONE
