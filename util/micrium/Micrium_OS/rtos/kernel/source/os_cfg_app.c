...
* File : os_cfg_app.c
*********************************************************************************************************
* Note(s) : (1) Do NOT modify this file.
*********************************************************************************************************
*/
...
* Return(s)   : None.
*
* Note(s)     : (1) This code doesn't do anything, it simply prevents the compiler from optimizing out the
*                   'const' variables which are declared in this file.
*
*               (2) You may decide to 'compile out' the code (by using #if 0/#endif) INSIDE the function if
