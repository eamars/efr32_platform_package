...
*********************************************************************************************************
*
*                                          NETWORK ETHERNET BSP
*
*                                             TEMPLATE FILE
*
* File : bsp_net_ether.c
*********************************************************************************************************
*/
...
#include  <rtos/drivers/net/include/net_drv_phy.h>

#include  <rtos/cpu/include/cpu.h>
#include  <rtos/cpu/include/cpu_int.h>
                                       ...
                                       RTOS_ERR  *p_err)
{
    ...
    CPU_IntSrcHandlerSetKA(ETH_IRQn + 16, BSP_NetEther_ISR_Handler);
