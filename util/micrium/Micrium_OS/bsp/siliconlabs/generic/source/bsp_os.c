...
#include  <rtos/common/source/kal/kal_priv.h>                   /* Private file, use should be limited. See Note #1.    */
...
#if defined(RTOS_MODULE_USB_DEV_AVAIL)
  USB_CTRLR_HW_INFO_REG("usb0", &BSP_USBD_EFM32_HwInfo, DEF_NULL);
#endif
#if defined(RTOS_MODULE_USB_HOST_AVAIL)
  USB_CTRLR_HW_INFO_REG("usb0", DEF_NULL, &BSP_USBH_EFM32_PBHCI_HW_Info);
#endif
