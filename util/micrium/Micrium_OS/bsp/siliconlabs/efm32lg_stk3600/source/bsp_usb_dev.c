...
*/
                                                                ...
                                                                /* ----------------- USB DEVICE FNCTS ----------------- */
static  void  BSP_USBD_EFM32LG_STK3600_Init   (USBD_DRV  *p_drv);

static  void  BSP_USBD_EFM32LG_STK3600_Conn   (void);

static  void  BSP_USBD_EFM32LG_STK3600_Disconn(void);

static  void  BSP_USBD_EFM32LG_IntHandler     (void);
...
static  USBD_DRV  *BSP_USBD_EFM32LG_DrvPtr;                     /* USB device driver specific info.                     */


                                                                /* ---------- USB DEVICE ENDPOINTS INFO TBL ----------- */
static  USBD_DRV_EP_INFO  BSP_USBD_EFM32LG_EP_InfoTbl[] = {
...
static  USBD_DRV_INFO  BSP_USBD_EFM32LG_DrvInfoPtr = {
    .BaseAddr   = 0x40100000u,
    .MemAddr    = 0x00000000u,
    .MemSize    = 0u,
    .Spd        = USBD_DEV_SPD_FULL,
    .EP_InfoTbl = BSP_USBD_EFM32LG_EP_InfoTbl
};

                                                                /* ------------- USB DEVICE BSP STRUCTURE ------------- */
static  USBD_DRV_BSP_API   BSP_USBD_EFM32LG_STK3600_BSP_API_Ptr = {
    BSP_USBD_EFM32LG_STK3600_Init,
    BSP_USBD_EFM32LG_STK3600_Conn,
    BSP_USBD_EFM32LG_STK3600_Disconn
};

                                                                /* ----------- USB DEVICE HW INFO STRUCTURE ----------- */
const  USBD_DEV_CTRLR_HW_INFO  BSP_USBD_EFM32LG_HwInfo = {
    .DrvAPI_Ptr  = &USBD_DrvAPI_EFM32_OTG_FS,
    .DrvInfoPtr  = &BSP_USBD_EFM32LG_DrvInfoPtr,
    .BSP_API_Ptr = &BSP_USBD_EFM32LG_STK3600_BSP_API_Ptr
};
