...
#include  <rtos/drivers/usb/include/usbh_pbhcd.h>
...
*/
                                                                ...
                                                                /* ------------------ USB HOST FNCTS ------------------ */
static  CPU_BOOLEAN  BSP_USBH_EFM32LG_STK3600_Init  (USBH_PBHCD_ISR_HANDLE_FNCT   isr_fnct,
                                                     USBH_PBHCI_HC_DRV           *p_pbhci_hc_drv);

static  CPU_BOOLEAN  BSP_USBH_EFM32LG_STK3600_ClkCfg(void);

static  CPU_BOOLEAN  BSP_USBH_EFM32LG_STK3600_IO_Cfg(void);

static  CPU_BOOLEAN  BSP_USBH_EFM32LG_STK3600_IntCfg(void);

static  CPU_BOOLEAN  BSP_USBH_EFM32LG_STK3600_PwrCfg(void);

static  CPU_BOOLEAN  BSP_USBH_EFM32LG_STK3600_Start (void);

static  CPU_BOOLEAN  BSP_USBH_EFM32LG_STK3600_Stop  (void);

static  void         BSP_USBH_EFM32LG_IntHandler    (void);
...
static  USBH_PBHCD_ISR_HANDLE_FNCT   BSP_USBH_EFM32LG_ISR_Fnct; /* Function to call when int occurs.                    */
static  USBH_PBHCI_HC_DRV           *BSP_USBH_EFM32LG_DrvPtr;   /* Pointer to data to pass to ISR.                      */

                                                                /* ------------------ BSP API STRUCT ------------------ */
static  USBH_PBHCI_BSP_API  BSP_USBH_EFM32LG_STK3600_BSP_API_Ptr = {
    BSP_USBH_EFM32LG_STK3600_Init,
    BSP_USBH_EFM32LG_STK3600_ClkCfg,
    BSP_USBH_EFM32LG_STK3600_IO_Cfg,
    BSP_USBH_EFM32LG_STK3600_IntCfg,
    BSP_USBH_EFM32LG_STK3600_PwrCfg,
    BSP_USBH_EFM32LG_STK3600_Start,
    BSP_USBH_EFM32LG_STK3600_Stop,
    DEF_NULL
};

                                                                /* ----------------- PIPE INFO TABLE ------------------ */
USBH_PBHCI_PIPE_INFO  BSP_USBH_EFM32LG_PipeInfoTbl[] =
{
    ...
    {DEF_BIT_NONE                                                                                            , 0u,    0u}
                                                                ...
                                                                /* ------------------ HW INFO STRUCT ------------------ */
const  USBH_PBHCI_HC_HW_INFO  BSP_USBH_EFM32LG_PBHCI_HW_Info = {
    ...
    .BSP_API_Ptr                        = &BSP_USBH_EFM32LG_STK3600_BSP_API_Ptr,
    .PipeInfoTblPtr                     =  BSP_USBH_EFM32LG_PipeInfoTbl
};
...
{
    BSP_USBH_EFM32LG_ISR_Fnct = isr_fnct;
    BSP_USBH_EFM32LG_DrvPtr   = p_hc_drv;
...
static  void  BSP_USBH_EFM32LG_IntHandler (void)
{
    BSP_USBH_EFM32LG_ISR_Fnct(BSP_USBH_EFM32LG_DrvPtr);
}
