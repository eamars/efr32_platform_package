...
static const  FS_NAND_CTRLR_GEN_HW_INFO  BSP_FS_NAND_CtrlrGen_HwInfo   = FS_NAND_CTRLR_GEN_HW_INFO_INIT(&FS_NAND_CtrlrGen_SoftEcc_Hamming_HwInfo,   /* TODO: insert appropriate ECC: Micron, software or other. */
                                                                                                        DEF_NULL,                                   /* TODO: insert appropriate driver API structure from fs_nand_ctrlr_drv.h. */
                                                                                                        &BSP_FS_NAND_BSP_API,
                                                                                                        BSP_MEM_CTRLR_BASE_ADDR,
                                                                                                        sizeof(CPU_ALIGN));
