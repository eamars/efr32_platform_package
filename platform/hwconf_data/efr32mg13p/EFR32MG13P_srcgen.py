...
# get module mapping
from efr32mg13p.modules.PIN.PIN_Class import *
import efr32mg13p.PythonSnippet.ExporterModel as ExporterModel
import efr32mg13p.PythonSnippet.Metadata as Metadata
import efr32mg13p.halconfig.halconfig_dependency as dep

from efr32mg13p.PythonSnippet.CodeGen import *
from efr32mg13p.PythonSnippet.StudioProject import *

import efr32mg13p.modules.ANTDIV.ANTDIV_behavior as ANTDIV_behavior
import efr32mg13p.modules.BATTERYMON.BATTERYMON_behavior as BATTERYMON_behavior
import efr32mg13p.modules.BTL_BUTTON.BTL_BUTTON_behavior as BTL_BUTTON_behavior
import efr32mg13p.modules.BULBPWM.BULBPWM_behavior as BULBPWM_behavior
import efr32mg13p.modules.BULBPWM_COLOR.BULBPWM_COLOR_behavior as BULBPWM_COLOR_behavior
import efr32mg13p.modules.BUTTON.BUTTON_behavior as BUTTON_behavior
import efr32mg13p.modules.CMU.CMU_behavior as CMU_behavior
import efr32mg13p.modules.COEX.COEX_behavior as COEX_behavior
import efr32mg13p.modules.CS5463.CS5463_behavior as CS5463_behavior
import efr32mg13p.modules.DCDC.DCDC_behavior as DCDC_behavior
import efr32mg13p.modules.EMU.EMU_behavior as EMU_behavior
import efr32mg13p.modules.EXTFLASH.EXTFLASH_behavior as EXTFLASH_behavior
import efr32mg13p.modules.EZRADIOPRO.EZRADIOPRO_behavior as EZRADIOPRO_behavior
import efr32mg13p.modules.GPIO.GPIO_behavior as GPIO_behavior
import efr32mg13p.modules.I2C0.I2C_behavior as I2C_behavior
import efr32mg13p.modules.I2C1.I2C_behavior as I2C_behavior
import efr32mg13p.modules.I2CSENSOR.I2CSENSOR_behavior as I2CSENSOR_behavior
import efr32mg13p.modules.IOEXP.IOEXP_behavior as IOEXP_behavior
import efr32mg13p.modules.LED.LED_behavior as LED_behavior
import efr32mg13p.modules.LEUART0.LEUART_behavior as LEUART_behavior
import efr32mg13p.modules.LNA.LNA_behavior as LNA_behavior
import efr32mg13p.modules.PA.PA_behavior as PA_behavior
import efr32mg13p.modules.PRS.PRS_behavior as PRS_behavior
import efr32mg13p.modules.PTI.PTI_behavior as PTI_behavior
import efr32mg13p.modules.PYD1698.PYD1698_behavior as PYD1698_behavior
import efr32mg13p.modules.SERIAL.SERIAL_behavior as SERIAL_behavior
import efr32mg13p.modules.SPIDISPLAY.SPIDISPLAY_behavior as SPIDISPLAY_behavior
import efr32mg13p.modules.SPINCP.SPINCP_behavior as SPINCP_behavior
import efr32mg13p.modules.TIMER0.TIMER_behavior as TIMER_behavior
import efr32mg13p.modules.TIMER1.TIMER_behavior as TIMER_behavior
import efr32mg13p.modules.UARTNCP.UARTNCP_behavior as UARTNCP_behavior
import efr32mg13p.modules.USART0.USART_behavior as USART_behavior
import efr32mg13p.modules.USART1.USART_behavior as USART_behavior
import efr32mg13p.modules.USART2.USART_behavior as USART_behavior
import efr32mg13p.modules.VCOM.VCOM_behavior as VCOM_behavior
import efr32mg13p.modules.VUART.VUART_behavior as VUART_behavior
import efr32mg13p.modules.WDOG.WDOG_behavior as WDOG_behavior
def generate(context):
    ...
    for transition in modeTransitions():
        ...
        familyobj = dep.Family('efr32mg13p')
