...
options = {
    "BSP_TIMER_CC0": {
        ...
        "description": "TIMER Compare/Capture Channel 0",
    },
    "BSP_TIMER_CC1": {
        "type": types.Pin(signal='CC1'),
        "description": "TIMER Compare/Capture Channel 1",
    },
    "BSP_TIMER_CC2": {
        "type": types.Pin(signal='CC2'),
        "description": "TIMER Compare/Capture Channel 2",
    },
    "BSP_TIMER_CC3": {
        "type": types.Pin(signal='CC3'),
        "description": "TIMER Compare/Capture Channel 3",
