...
# get module mapping
from efr32bg1p.modules.PIN.PIN_Class import *
...
from efr32bg1p.PythonSnippet.CodeGen import *
from efr32bg1p.PythonSnippet.StudioProject import *
...
def generate(context):
    ...
    for transition in modeTransitions():
        ...
        familyobj = dep.Family('efr32bg1p')
