...
# get module mapping
from efr32mg1b.modules.PIN.PIN_Class import *
import efr32mg1b.PythonSnippet.ExporterModel as ExporterModel
import efr32mg1b.PythonSnippet.Metadata as Metadata
import efr32mg1b.halconfig.halconfig_dependency as dep

from efr32mg1b.PythonSnippet.CodeGen import *
from efr32mg1b.PythonSnippet.StudioProject import *

import efr32mg1b.modules.ANTDIV.ANTDIV_behavior as ANTDIV_behavior
import efr32mg1b.modules.BATTERYMON.BATTERYMON_behavior as BATTERYMON_behavior
import efr32mg1b.modules.BTL_BUTTON.BTL_BUTTON_behavior as BTL_BUTTON_behavior
import efr32mg1b.modules.BULBPWM.BULBPWM_behavior as BULBPWM_behavior
import efr32mg1b.modules.BULBPWM_COLOR.BULBPWM_COLOR_behavior as BULBPWM_COLOR_behavior
import efr32mg1b.modules.BUTTON.BUTTON_behavior as BUTTON_behavior
import efr32mg1b.modules.CMU.CMU_behavior as CMU_behavior
import efr32mg1b.modules.COEX.COEX_behavior as COEX_behavior
import efr32mg1b.modules.CS5463.CS5463_behavior as CS5463_behavior
import efr32mg1b.modules.DCDC.DCDC_behavior as DCDC_behavior
import efr32mg1b.modules.EMU.EMU_behavior as EMU_behavior
import efr32mg1b.modules.EXTFLASH.EXTFLASH_behavior as EXTFLASH_behavior
import efr32mg1b.modules.EZRADIOPRO.EZRADIOPRO_behavior as EZRADIOPRO_behavior
import efr32mg1b.modules.GPIO.GPIO_behavior as GPIO_behavior
import efr32mg1b.modules.I2C0.I2C_behavior as I2C_behavior
import efr32mg1b.modules.I2CSENSOR.I2CSENSOR_behavior as I2CSENSOR_behavior
import efr32mg1b.modules.IOEXP.IOEXP_behavior as IOEXP_behavior
import efr32mg1b.modules.LED.LED_behavior as LED_behavior
import efr32mg1b.modules.LEUART0.LEUART_behavior as LEUART_behavior
import efr32mg1b.modules.LNA.LNA_behavior as LNA_behavior
import efr32mg1b.modules.PA.PA_behavior as PA_behavior
import efr32mg1b.modules.PRS.PRS_behavior as PRS_behavior
import efr32mg1b.modules.PTI.PTI_behavior as PTI_behavior
import efr32mg1b.modules.PYD1698.PYD1698_behavior as PYD1698_behavior
import efr32mg1b.modules.SERIAL.SERIAL_behavior as SERIAL_behavior
import efr32mg1b.modules.SPIDISPLAY.SPIDISPLAY_behavior as SPIDISPLAY_behavior
import efr32mg1b.modules.SPINCP.SPINCP_behavior as SPINCP_behavior
import efr32mg1b.modules.TIMER0.TIMER_behavior as TIMER_behavior
import efr32mg1b.modules.TIMER1.TIMER_behavior as TIMER_behavior
import efr32mg1b.modules.UARTNCP.UARTNCP_behavior as UARTNCP_behavior
import efr32mg1b.modules.USART0.USART_behavior as USART_behavior
import efr32mg1b.modules.USART1.USART_behavior as USART_behavior
import efr32mg1b.modules.VCOM.VCOM_behavior as VCOM_behavior
import efr32mg1b.modules.VUART.VUART_behavior as VUART_behavior
import efr32mg1b.modules.WDOG.WDOG_behavior as WDOG_behavior
def generate(context):
    ...
    for transition in modeTransitions():
        ...
        familyobj = dep.Family('efr32mg1b')
