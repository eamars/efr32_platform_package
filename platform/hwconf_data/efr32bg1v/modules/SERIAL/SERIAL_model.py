...
options = {
    ...
    "HAL_SERIAL_UART0_ENABLE": {
        ...
        "dependency": dep.Dependency(has_peripheral=['UART0'], platform=dep.Platform.SERIES1, mcu_type=dep.McuType.RADIO),
        "advanced": True,
    },
    "HAL_SERIAL_UART1_ENABLE": {
        "type": "boolean",
        "description": "Use UART1 for serial",
        "dependency": dep.Dependency(has_peripheral=['UART1'], platform=dep.Platform.SERIES1, mcu_type=dep.McuType.RADIO),
        "advanced": True,
    },
    "HAL_SERIAL_USART0_ENABLE": {
        "type": "boolean",
        "description": "Use USART0 for serial",
        "dependency": dep.Dependency(has_peripheral=['USART0'], platform=dep.Platform.SERIES1, mcu_type=dep.McuType.RADIO),
        "advanced": True,
    },
    "HAL_SERIAL_USART1_ENABLE": {
        "type": "boolean",
        "description": "Use USART1 for serial",
        "dependency": dep.Dependency(has_peripheral=['USART1'], platform=dep.Platform.SERIES1, mcu_type=dep.McuType.RADIO),
        "advanced": True,
    },
    "HAL_SERIAL_USART2_ENABLE": {
        "type": "boolean",
        "description": "Use USART2 for serial",
        "dependency": dep.Dependency(has_peripheral=['USART2'], platform=dep.Platform.SERIES1, mcu_type=dep.McuType.RADIO),
        "advanced": True,
    },
    "HAL_SERIAL_USART3_ENABLE": {
        "type": "boolean",
        "description": "Use USART3 for serial",
        "dependency": dep.Dependency(has_peripheral=['USART3'], platform=dep.Platform.SERIES1, mcu_type=dep.McuType.RADIO),
        "advanced": True,
    },
}
