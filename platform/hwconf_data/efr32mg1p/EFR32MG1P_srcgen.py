...
# get module mapping
from efr32mg1p.modules.PIN.PIN_Class import *
import efr32mg1p.PythonSnippet.ExporterModel as ExporterModel
import efr32mg1p.PythonSnippet.Metadata as Metadata
import efr32mg1p.halconfig.halconfig_dependency as dep

from efr32mg1p.PythonSnippet.CodeGen import *
from efr32mg1p.PythonSnippet.StudioProject import *

import efr32mg1p.modules.ANTDIV.ANTDIV_behavior as ANTDIV_behavior
import efr32mg1p.modules.BATTERYMON.BATTERYMON_behavior as BATTERYMON_behavior
import efr32mg1p.modules.BTL_BUTTON.BTL_BUTTON_behavior as BTL_BUTTON_behavior
import efr32mg1p.modules.BULBPWM.BULBPWM_behavior as BULBPWM_behavior
import efr32mg1p.modules.BULBPWM_COLOR.BULBPWM_COLOR_behavior as BULBPWM_COLOR_behavior
import efr32mg1p.modules.BUTTON.BUTTON_behavior as BUTTON_behavior
import efr32mg1p.modules.CMU.CMU_behavior as CMU_behavior
import efr32mg1p.modules.COEX.COEX_behavior as COEX_behavior
import efr32mg1p.modules.CS5463.CS5463_behavior as CS5463_behavior
import efr32mg1p.modules.DCDC.DCDC_behavior as DCDC_behavior
import efr32mg1p.modules.EMU.EMU_behavior as EMU_behavior
import efr32mg1p.modules.EXTFLASH.EXTFLASH_behavior as EXTFLASH_behavior
import efr32mg1p.modules.EZRADIOPRO.EZRADIOPRO_behavior as EZRADIOPRO_behavior
import efr32mg1p.modules.GPIO.GPIO_behavior as GPIO_behavior
import efr32mg1p.modules.I2C0.I2C_behavior as I2C_behavior
import efr32mg1p.modules.I2CSENSOR.I2CSENSOR_behavior as I2CSENSOR_behavior
import efr32mg1p.modules.IOEXP.IOEXP_behavior as IOEXP_behavior
import efr32mg1p.modules.LED.LED_behavior as LED_behavior
import efr32mg1p.modules.LEUART0.LEUART_behavior as LEUART_behavior
import efr32mg1p.modules.LNA.LNA_behavior as LNA_behavior
import efr32mg1p.modules.PA.PA_behavior as PA_behavior
import efr32mg1p.modules.PRS.PRS_behavior as PRS_behavior
import efr32mg1p.modules.PTI.PTI_behavior as PTI_behavior
import efr32mg1p.modules.PYD1698.PYD1698_behavior as PYD1698_behavior
import efr32mg1p.modules.SERIAL.SERIAL_behavior as SERIAL_behavior
import efr32mg1p.modules.SPIDISPLAY.SPIDISPLAY_behavior as SPIDISPLAY_behavior
import efr32mg1p.modules.SPINCP.SPINCP_behavior as SPINCP_behavior
import efr32mg1p.modules.TIMER0.TIMER_behavior as TIMER_behavior
import efr32mg1p.modules.TIMER1.TIMER_behavior as TIMER_behavior
import efr32mg1p.modules.UARTNCP.UARTNCP_behavior as UARTNCP_behavior
import efr32mg1p.modules.USART0.USART_behavior as USART_behavior
import efr32mg1p.modules.USART1.USART_behavior as USART_behavior
import efr32mg1p.modules.VCOM.VCOM_behavior as VCOM_behavior
import efr32mg1p.modules.VUART.VUART_behavior as VUART_behavior
import efr32mg1p.modules.WDOG.WDOG_behavior as WDOG_behavior
def generate(context):
    ...
    for transition in modeTransitions():
        ...
        familyobj = dep.Family('efr32mg1p')
