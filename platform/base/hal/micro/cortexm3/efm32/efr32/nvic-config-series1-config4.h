...
/* *INDENT-OFF**/
    ...
    SEGMENT()
    SEGMENT2()
    EXCEPTION(     54, VDAC0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     55, LESENSE_IRQHandler,           4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     56, TRNG0_IRQHandler,             4,         0)

    SEGMENT()
    SEGMENT2()
    EXCEPTION(     57, halReserved66Isr,     NVIC_NONE, NVIC_NONE)
