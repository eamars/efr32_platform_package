...
#define BSP_EZRADIOPRO_SDN_PIN                        (12)
#define BSP_EZRADIOPRO_SDN_PORT                       (gpioPortD)

#define BSP_EZRADIOPRO_CS_PIN                         (10)
#define BSP_EZRADIOPRO_CS_PORT                        (gpioPortD)

#define BSP_EZRADIOPRO_INT_PIN                        (11)
#define BSP_EZRADIOPRO_INT_PORT                       (gpioPortD)

#define BSP_EZRADIOPRO_USART                          (HAL_SPI_PORT_USART1)
#define BSP_EZRADIOPRO_CLK_PIN                        (8)
#define BSP_EZRADIOPRO_CLK_PORT                       (gpioPortC)
#define BSP_EZRADIOPRO_CLK_LOC                        (11)

#define BSP_EZRADIOPRO_MISO_PIN                       (7)
#define BSP_EZRADIOPRO_MISO_PORT                      (gpioPortC)
#define BSP_EZRADIOPRO_MISO_LOC                       (11)

#define BSP_EZRADIOPRO_MOSI_PIN                       (6)
#define BSP_EZRADIOPRO_MOSI_PORT                      (gpioPortC)
#define BSP_EZRADIOPRO_MOSI_LOC                       (11)
...
#define BSP_I2CSENSOR_ENABLE_PIN                      (15)
