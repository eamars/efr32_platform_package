...
#define BSP_EXTFLASH_WP_PIN                           (6)
#define BSP_EXTFLASH_WP_PORT                          (gpioPortF)
#define BSP_EXTFLASH_CS_PIN                           (8)
#define BSP_EXTFLASH_CS_PORT                          (gpioPortC)
#define BSP_EXTFLASH_MISO_PIN                         (9)
#define BSP_EXTFLASH_MISO_PORT                        (gpioPortC)
#define BSP_EXTFLASH_MISO_LOC                         (13)
#define BSP_EXTFLASH_MOSI_PIN                         (5)
#define BSP_EXTFLASH_MOSI_PORT                        (gpioPortF)
#define BSP_EXTFLASH_MOSI_LOC                         (29)
#define BSP_EXTFLASH_CLK_PIN                          (4)
#define BSP_EXTFLASH_CLK_PORT                         (gpioPortF)
#define BSP_EXTFLASH_CLK_LOC                          (26)
#define BSP_EXTFLASH_HOLD_PIN                         (5)
#define BSP_EXTFLASH_HOLD_PORT                        (gpioPortA)
// [EXTFLASH]$
...
#define BSP_SPINCP_CS_PIN                             (14)
#define BSP_SPINCP_CS_PORT                            (gpioPortD)
#define BSP_SPINCP_CS_LOC                             (19)
...
#define PORTIO_USART1_CS_LOC                          (19)
